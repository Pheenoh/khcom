...
INCLUDE_ASM("mode_test/mode_test_0.s");
INCLUDE_ASM("mode_test/mode_test_1.s");
INCLUDE_ASM("mode_test/mode_test_2.s");
...
INCLUDE_ASM("mode_test/func_0805F588.s");
INCLUDE_ASM("mode_test/func_0805F5A4.s");
INCLUDE_ASM("mode_test/func_0805F7B0.s");
...
INCLUDE_ASM("mode_test/func_08060598.s");
INCLUDE_ASM("mode_test/func_080605A4.s");
INCLUDE_ASM("mode_test/func_0806098C.s");
INCLUDE_ASM("mode_test/func_080609A0.s");
