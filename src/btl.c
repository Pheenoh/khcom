...
u8 task_btl_lockon_1(BtlLockonWork* work) {
    ...
    if (gBtlWork->actor2 != 0) {
        ...
        if (gBtlWork->actor2->unk_034 & 0x1000000) {
            gBtlWork->actor2 = 0;
        }
    }
...
void task_btl_sora_0(BtlSoraWork* work, BtlTaskArg* arg) {
    ...
    if (arg != 0) {
        ...
        if ((e->btl->unk_068 & 0x800) || (e->btl->unk_068 & 0x800000000LL)) {
            e->unk_004 = 0xC000;
        } else {
            e->unk_004 = 0x10000;
        }
...
s32 task_btl_sora_1(BtlSoraWork* work) {
    ...
    if (work->unk_038 != 15 && (p->btl->unk_068 & 0x10)) {
        p->unk_034 |= 0x800000;
        work->unk_038 = 15;
        work->unk_156 = 0;
        work->unk_154 = 0;
        ...
        p->btl->unk_068 &= ~0x0010000000000000LL;
    }
    ...
    case 1: {
        ...
        if (t2 != 18) {
            ...
            if ((p->btl->unk_068 & 0x1000000) && p->btl->unk_0F4 != 30) {
    ...
    case 33:
        ...
        break;
    case 10:
        if ((p->btl->unk_068 & 0x8000) || p->unk_00C < p->unk_010) {
            func_0801DD08(work);
            break;
        }
    ...
    case 16: {
        ...
        if (AnimIsFinished(&work->anim) != 0 && (p->btl->unk_068 & 0x8000) == 0) {
            func_0801E4E4(work, 1);
            break;
        }
...
s32 task_btl_riku_1(BtlRikuWork* work) {
    ...
    if (work->unk_03C != 8 && (p->btl->unk_068 & 0x10)) {
        p->unk_034 |= 0x800000;
        work->unk_03C = 8;
        work->unk_15A = 0;
        work->unk_158 = 0;
