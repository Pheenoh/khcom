...
s32 func_080F173C(MapGmkJumpWork* w) {
    if (w->unk_070 != 0) {
        w->unk_060 = AnimUpdate(&w->unk_040);
        ApproachValue(&w->unk_008, *(s32*)&w->unk_06C, w->unk_070);
        w->unk_070--;
    } else {
        gUnk_0203C7AC->unk_00 |= 2;
        gUnk_02039BA0->unk_70 |= 0x80;
...
s32 func_080F1A84(MapGmkTutorialWork* w) {
    if (gUnk_02039BA0->unk_70 & 0x200000) {
...
u8 func_080F3210(MapGmkGp8Work* w) {
    ...
    if (func_080E8374((UnkStruct_080E8374*)&w->unk_000[4])) {
        func_08012614(w->unk_044, 1);
    } else {
        func_08012614(w->unk_044, 0);
    }
