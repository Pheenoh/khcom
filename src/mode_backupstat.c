...
INCLUDE_ASM("mode_backupstat/func_08109F20.s");
...
INCLUDE_ASM("mode_backupstat/func_0810A4C4.s");
INCLUDE_ASM("mode_backupstat/func_0810A4CC.s");
INCLUDE_ASM("mode_backupstat/func_0810A51C.s");
