...
void func_08012674(void) {
    ...
    gUnk_02034928->update = 0;
    gUnk_02034928->unk_08 = 0;
    gUnk_02034928->z = 0;
    gUnk_02034928->flags = 2;
...
void func_08012728(s16 a) {
    ...
    if (BgAnimGetDuration(BgAnimGetCurrent()) - b * c <= a) {
        ...
        if (gUnk_02034928->flags & 8) {
            gUnk_02034928->flags &= ~8;
            FadeToOriginal(0, 8);
        }
    }
}
...
void func_08012824(void) {
    if (gBtlWork->flags & 0x400000) {
        ...
        gUnk_02034928->flags &= 0xFFFD;
        gUnk_02034928->update = 0;
        BgAnimStop();
        SetBgBlend(gUnk_02034928->unk_00, 16, 16);
    }

    if (gUnk_02034928->update != 0) {
        gUnk_02034928->update();

        if (!(gBtlWork->flags & 4)) {
            gBtlWork->unk_0D0 = gUnk_02034928->y;

            if (gUnk_02034928->flags & 0x10) {
                SetBgPriority(gUnk_02034928->unk_00, 0);
            } else if (gUnk_02034928->flags & 0x20) {
                SetBgPriority(gUnk_02034928->unk_00, 1);
...
void func_08012908(void) {
    ...
    WorldToScreen(&sx, &sy, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z);
    BgAnimSetPosition(sx, sy);

    if (gUnk_02034928->flags & 4) {
...
void func_08012AAC(u16 a, s32 x, s32 y, s32 z) {
    ...
    switch (a) {
    case 0:
        gUnk_02034928->z = z - 0x1400;
        break;
    case 1:
        gUnk_02034928->z = z;
        break;
    case 2:
        gUnk_02034928->z = z - 0x1000;
        break;
    }
    WorldToScreen(&sx, &sy, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z);
    ...
    gUnk_02034928->flags |= 8;
    gUnk_02034928->update = func_08012908;
}
...
void func_08012C08(void) {
    ...
    if (gUnk_02034928->unk_08 > 0) {
        if (a > 7) {
            ...
            if (gUnk_02034928->flags & 1) {
                ApproachAngle(&ang, GetAngle(gUnk_02034928->x, gUnk_02034928->y,
            ...
            ApproachValue(&gUnk_02034928->x, gUnk_02034928->unk_28, gUnk_02034928->unk_08);
            ApproachValue(&gUnk_02034928->y, gUnk_02034928->unk_2C, gUnk_02034928->unk_08);
            ApproachValue(&gUnk_02034928->z, gUnk_02034928->unk_30, gUnk_02034928->unk_08);

            if (func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x, gUnk_02034928->y,
                              gUnk_02034928->z, 8, 8, 16)) {
            ...
            if (func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x + dx,
                              gUnk_02034928->y, gUnk_02034928->z, 8, 8, 16)) {
                gUnk_02034928->unk_08 = -1;
            }
        }
    }
    ...
    if (gUnk_02034928->unk_08 == 0) {
        gUnk_02034928->update = func_08012BCC;
        ...
        gUnk_02034928->x += dx;
        gUnk_02034928->unk_4C = 20;
        WorldToScreen(&sx, &sy, gUnk_02034928->x, gUnk_02034928->y,
                      gUnk_02034928->z);
...
void func_08012E44(u16 a, s32 x, s32 y, s32 z, s32 p, s32 q, s32 r, u8 f, s32 w) {
    ...
    gUnk_02034928->update = func_08012C08;
...
void func_08012F74(s32 x, s32 y, s32 z, u8 f, s32 unused, s32 w, u16 a) {
    ...
    BgAnimSetLoopStartFrame(8);
    gUnk_02034928->update = func_08012C08;
    gUnk_02034928->unk_28 = gBtlWork->actor->x;
    gUnk_02034928->unk_2C = gBtlWork->actor->y;
    gUnk_02034928->unk_30 = gBtlWork->actor->z;
...
void func_08013070(void) {
    ...
    if (gUnk_02034928->unk_08 > 0) {
        if (a > 7) {
            ...
            if (gUnk_02034928->flags & 1) {
                ApproachAngle(&angle,
                    GetAngle(gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->unk_28,
            ...
            if (func_08011E3C(gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z, 8, 16, 16)) {
                gUnk_02034928->unk_08 = -1;
            } else {
                gUnk_02034928->unk_08--;
            }
            ...
            if (func_08011E3C(gUnk_02034928->x + dx, gUnk_02034928->y, gUnk_02034928->z, 8, 16, 16)) {
                gUnk_02034928->unk_08 = -1;
            }
        }
    }
    ...
    if (gUnk_02034928->unk_08 == -2) {
        ...
        case 0:
            if (gUnk_02034928->unk_0A == 20) {
                func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x, gUnk_02034928->y,
                    gUnk_02034928->z, 18, 18, 18);
            }
            break;
        case 1:
            if (gUnk_02034928->unk_0A == 35) {
                func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x, gUnk_02034928->y,
                    gUnk_02034928->z, 24, 24, 30);
            }
            break;
        case 2:
        default:
...
void func_08013308(u16 a, s32 x, s32 y, s32 z, s32 p, s32 q, s32 r, u8 f, s32 w) {
    ...
    BgAnimSetLoopStartFrame(8);
    gUnk_02034928->update = func_08013070;
    gUnk_02034928->unk_28 = p;
    gUnk_02034928->unk_2C = q;
    gUnk_02034928->unk_30 = r;
    gUnk_02034928->unk_08 = 15;
...
void func_08013480(s32 x, s32 y, s32 z) {
    ...
    gUnk_02034928->update = func_08013420;
    gUnk_02034928->unk_08 = 0;
}
...
void func_08013560(s32 x, s32 y, s32 z) {
    ...
    BgAnimStart(&gUnk_09EDA618, sx, sy);
    BgAnimSetLoopStartFrame(0);
    gUnk_02034928->update = func_0801350C;
    gUnk_02034928->unk_08 = 0;
}
...
void func_08013B00(void) {
    ...
    if (gUnk_02034928->unk_08 == 0 && BgAnimIsStopped()) {
        SetBlendAlpha(16, 16);
        gUnk_02034928->x = gBtlWork->unk_000;
        gUnk_02034928->y = (gBtlWork->unk_0DE + gBtlWork->unk_0E0) << 7;
        gUnk_02034928->z = gUnk_02034928->unk_30;
        WorldToScreen(&sx, &sy, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z);
        gUnk_02034928->unk_24 = 0;
        gUnk_02034928->unk_4C = 20;
        gUnk_02034928->flags |= 4;
        ...
        switch (gUnk_02034928->unk_26) {
        case 0:
            func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z, 32, 256, 256);
            BgAnimStart(&gUnk_09EDA798, sx, sy);
            m4aSongNumStart(0x201);
            break;
        case 1:
            func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z, 256, 256, 256);
        ...
        WorldToScreen(&sx2, &sy2, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z);
        t = sy2 << 8;
...
void func_08013CB4(u16 a, s32 x, s32 y, s32 z, s32 p, s32 q) {
    ...
    gUnk_02034928->update = func_08013B00;
    gUnk_02034928->unk_26 = a;
    FadeToAmount(0, gBtlWork->unk_0B3, 8);
    gUnk_02034928->flags |= 8;
}
...
void func_08013DB8(s32 x, s32 y, s32 z, s32 s) {
    ...
    gUnk_02034928->update = func_08013D60;
...
void func_08014020(s32 x, s32 y, s32 z) {
    ...
    gUnk_02034928->update = func_08014000;
    m4aSongNumStart(0x22C);
    gUnk_02034928->flags |= 0x10;
    FadeToAmount(0, gBtlWork->unk_0B3, 8);
    gUnk_02034928->flags |= 8;
}
...
void func_080141FC(BtlObj* p) {
    ...
    BgAnimStart(&gUnk_09EDA768, sx, sy);
    BgAnimSetLoopStartFrame(4);
    gUnk_02034928->update = func_080141D4;
    FadeToAmount(0, gBtlWork->unk_0B3, 8);
    gUnk_02034928->flags |= 8;
}
void func_08014294(void) {
    ...
    case 1:
        ...
        gUnk_02034928->z += gUnk_02034928->unk_3C;

        if (gUnk_02034928->z > 0) {
            gUnk_02034928->z = 0;
            gUnk_02034928->unk_26 = 2;
            gUnk_02034928->unk_08 = 30;
        }

        gUnk_02034928->x += (gUnk_02034928->unk_28 - gUnk_02034928->x) >> 5;
        gUnk_02034928->unk_24 += 4;
        break;
    case 2:
    ...
    func_08011F78(256, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z, 32, 32, 32);
    func_08012908();
}
void func_0801435C(s32 x, s32 y, s32 z, s32 w, s32 v) {
    ...
    BgAnimStart(&gUnk_09EDA768, sx, sy);
    BgAnimSetLoopStartFrame(4);
    gUnk_02034928->update = func_08014294;
    FadeToAmount(0, gBtlWork->unk_0B3, 8);
    gUnk_02034928->flags |= 8;
}
...
void func_080144D8(s32 x, s32 y, s32 z, s32 w, u16 a, u16 b) {
    ...
    BgAnimSetLoopStartFrame(0);
    gUnk_02034928->update = func_0801440C;
...
void func_080146A8(s32 x, s32 y, s32 z) {
    ...
    BgAnimStart(&gUnk_09EDA618, sx, sy);
    BgAnimSetLoopStartFrame(0);
    gUnk_02034928->update = func_08014654;
    gUnk_02034928->unk_08 = 0;
    FadeToAmount(0, gBtlWork->unk_0B3, 8);
    gUnk_02034928->flags |= 8;
}
...
#endif
            func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z, 16, 16, 48);
        }
        break;
    case 1:
#ifdef VERSION_EU
...
#endif
            func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z, 24, 24, 48);
        }
        break;
    case 2:
        if (gUnk_02034928->unk_08 == 33) {
            func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z, 32, 32, 48);
        }
        break;
    }
    gUnk_02034928->unk_08++;
...
void func_080148E0(u16 a, s32 x, s32 y, s32 z, s32 w) {
    ...
    gUnk_02034928->update = func_08014850;
}
...
void func_08014BA8(void) {
    ...
    if (gUnk_02034928->unk_0A == 0 && BgAnimIsStopped()) {
        gUnk_02034928->x = gUnk_02034928->unk_28;
        gUnk_02034928->y = gUnk_02034928->unk_2C;
        gUnk_02034928->z = gUnk_02034928->unk_30;
        WorldToScreen(&sx, &sy, gUnk_02034928->x, gUnk_02034928->x, gUnk_02034928->z);
        gUnk_02034928->unk_24 = 0;
        gUnk_02034928->unk_4C = 20;
        ...
        if (gUnk_02034928->unk_08 == 35) {
            switch (gUnk_02034928->unk_26) {
            case 0:
                r = func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z, 24, 12, 256);
                break;
            case 1:
                r = func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z, 40, 20, 256);
                break;
            case 2:
            default:
                r = func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z, 80, 40, 256);
                break;
            }
...
void func_08014D78(u16 a, s32 x, s32 y, s32 z, s32 p, s32 q, s32 r, u8 f, s32 w) {
    ...
    gUnk_02034928->unk_26 = a;
    gUnk_02034928->update = func_08014BA8;
}
...
void func_08014E38(void) {
    ...
    if (gUnk_02034928->unk_08 == 0x23) {
        if (func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z, 40, 20, 256)) {
            m4aSongNumStart(0x234);
        }
    }
    func_08012908();
...
void func_08014EC0(s32 x, s32 y, s32 z, s32 w) {
    ...
    BgAnimStart(&gUnk_09EDA990, sx, sy);
    m4aSongNumStart(0x233);
    gUnk_02034928->update = func_08014E38;
}
...
void func_08014FDC(s32 x, s32 y, u8 f) {
    ...
    func_08012674();
    gUnk_02034928->x = x;
    gUnk_02034928->y = y - 0x1000;
    SetBlendAlpha(16, 8);

    if (f) {
        gUnk_02034928->flags |= 1;
    }
    WorldToScreen(&sx, &sy, gUnk_02034928->x, gUnk_02034928->y, 0);
    gUnk_02034928->unk_1C = 128;
    gUnk_02034928->unk_20 = 128;
    gUnk_02034928->unk_24 = 0;
    gUnk_02034928->unk_0A = 0;
    BgAnimStart(&gUnk_09EDA618, sx, sy);
    BgAnimSetLoopStartFrame(0);
    gUnk_02034928->update = func_08014F4C;
    gUnk_02034928->unk_08 = 0;
    gUnk_02034928->flags |= 0x10;
}
...
void func_080150D8(s32 x, s32 y, s32 z, u8 f) {
    ...
    gUnk_02034928->update = func_0801508C;
...
void func_08015228(s32 x, s32 y, s32 z, s32 s) {
    ...
    BgAnimSetLoopStartFrame(0);
    gUnk_02034928->update = func_0801519C;
    FadeToAmount(0, gBtlWork->unk_0B3, 8);
    gUnk_02034928->flags |= 8;
}
...
void func_0801536C(void) {
    ...
    gUnk_02034928->update = func_080152DC;
    gUnk_02034928->flags |= 0x10;
}
...
void func_080153C8(void) {
    ...
    case 1:
        ...
        if (gUnk_02034928->unk_08 <= 0) {
            gUnk_02034928->unk_08 = 0;
            gUnk_02034928->unk_26 = 2;
        } else if (func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z, u, u, u)) {
    ...
    case 2:
        ...
        if (t > 15) {
            ...
            gUnk_02034928->z -= gUnk_02034928->unk_1C;
            gUnk_02034928->unk_08++;
        }
        break;
    }
...
void func_080154F4(s32 x, s32 y, s32 z, s32 p, s32 q, s32 r, s32 s, u16 a, s32 t) {
    ...
    gUnk_02034928->unk_1C = 25;
    gUnk_02034928->unk_20 = 25;
    gUnk_02034928->update = func_080153C8;
    gUnk_02034928->unk_26 = 0;
...
void func_080155BC(s32 x, s32 y, s32 z, s32 w) {
    ...
    BgAnimStart(&gUnk_09EDA798, sx, sy);
    m4aSongNumStart(0x201);
    func_08011F78(w, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z, 16, 16, 256);
    gUnk_02034928->update = func_08012908;
    FadeToAmount(0, gBtlWork->unk_0B3, 8);
    gUnk_02034928->flags |= 8;
}
void func_08015698(void) {
    ...
    if (gUnk_02034928->unk_08 == 0 && BgAnimIsStopped()) {
        ...
        switch (gUnk_02034928->unk_26) {
        case 0:
            func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z, 16, 16, 256);
            BgAnimStart(&gUnk_09EDA798, sx, sy);
            m4aSongNumStart(0x201);
            break;
        case 1:
            func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z, 40, 40, 256);
            BgAnimStart(&gUnk_09EDA7B0, sx, sy);
            m4aSongNumStart(0x202);
            break;
        case 2:
            func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z, 64, 64, 256);
            BgAnimStart(&gUnk_09EDA7C8, sx, sy);
            m4aSongNumStart(0x203);
            break;
        }
...
void func_08015834(u16 a, s32 x, s32 y, s32 z, s32 p, s32 q, s32 r, s32 s) {
    ...
    m4aSongNumStart(0x200);
    gUnk_02034928->unk_48 = s;
    gUnk_02034928->update = func_08015698;
    gUnk_02034928->unk_26 = a;
    FadeToAmount(0, gBtlWork->unk_0B3, 8);
    gUnk_02034928->flags |= 8;
}
void func_080158E8(void) {
    ...
    case 0:
        ...
        if (gUnk_02034928->flags & 1) {
            func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x + t, gUnk_02034928->y,
                gUnk_02034928->z, t << 8 >> 16, 24, 24);
        } else {
            func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x - t, gUnk_02034928->y,
                gUnk_02034928->z, t << 8 >> 16, 24, 24);
        }
...
void func_08015B50(u16 a, s32 x, s32 y, s32 z, u8 f, s32 w) {
    ...
    BgAnimSetLoopStartFrame(0);
    gUnk_02034928->update = func_080158E8;
    FadeToAmount(0, gBtlWork->unk_0B3, 8);
    gUnk_02034928->flags |= 8;
}
...
void func_08015D30(s32 x, s32 y, s32 z) {
    ...
    gUnk_02034928->unk_20 = 0x100;
    WorldToScreen(&sx, &sy, x, y, z);
    gUnk_02034928->flags |= 0x20;
    SetBlendAlpha(16, 0);
    gUnk_02034928->unk_26 = 0;
    BgAnimStart(&gUnk_09EDAA80, sx, sy);
    BgAnimSetLoopStartFrame(0);
    gUnk_02034928->update = func_08015D04;
}
...
void func_08015E3C(void) {
    ...
    case 1: {
        ...
        if ((s16)t > 32) {
            func_08011F78(87, gUnk_02034928->x, gUnk_02034928->y, 0, 0x100, 0x100, 0x100);
...
void func_08015F3C(s32 x, s32 y, s32 z) {
    ...
    gUnk_02034928->unk_26 = 0;
    gUnk_02034928->flags |= 0x10;
    gUnk_02034928->update = func_08015E3C;
    FadeStartOut(2, 40);
...
void func_08016038(s32 x, s32 y, s32 z) {
    ...
    gUnk_02034928->update = func_08015FF4;
}
...
void func_080160C0(void) {
    ...
    switch (k) {
    case 4:
        func_08011F78(91, gUnk_02034928->x + gUnk_02034928->unk_1C * 40, gUnk_02034928->y, gUnk_02034928->z, 32, 32, 50);
        break;
    case 5:
        if (v == 0) {
            gUnk_02034928->unk_26 = 1;
    ...
    case 1:
        ...
        if (gUnk_02034928->flags & 1) {
            gUnk_02034928->x -= gUnk_02034928->unk_3C;
        } else {
            gUnk_02034928->x += gUnk_02034928->unk_3C;
        }
        break;
...
void func_080161F8(s32 x, s32 y, s32 z, u8 f) {
    ...
    gUnk_02034928->update = func_080160C0;
}
...
void func_08016468(void) {
    ...
    case 0:
        ...
        if (gUnk_02034928->unk_0A > 0) {
            ApproachValueHalfSteps(&gUnk_02034928->z, gUnk_02034928->unk_30 - 0x2000, gUnk_02034928->unk_0A);
            gUnk_02034928->unk_0A--;
        } else {
            gUnk_02034928->unk_26 = 1;
    ...
    case 2:
        ...
        if (o != 0) {
            ApproachValueHalfSteps(&gUnk_02034928->x, o->x, gUnk_02034928->unk_0A);
            ApproachValueHalfSteps(&gUnk_02034928->y, o->y, gUnk_02034928->unk_0A);
            ApproachValueHalfSteps(&gUnk_02034928->z, o->z - (o->unk_0A2 << 8), gUnk_02034928->unk_0A);
        }
        gUnk_02034928->unk_0A--;
...
void func_080165DC(s32 x, s32 y, s32 z) {
    ...
    gUnk_02034928->update = func_08016468;
...
void func_08016750(s32 x, s32 y, s32 z, u8 f) {
    ...
    gUnk_02034928->update = func_080166F8;
}
...
void func_080168B8(s32 x, s32 y, s32 z, u8 f, s32 w, u16 a) {
    ...
    gUnk_02034928->update = func_080167F8;
    BgAnimSetLoopStartFrame(0);
    FadeToAmount(0, gBtlWork->unk_0B3, 8);
    gUnk_02034928->flags |= 8;
}
...
void func_08016A64(void) {
    if (gUnk_02034928->flags & 1) {
        gUnk_02034928->x += 0x700;
    } else {
        gUnk_02034928->x += -0x700;
    }

    if (gUnk_02034928->x < (gBtlWork->unk_0DA - 0x40) << 8 || gUnk_02034928->x > (gBtlWork->unk_0DC + 0x40) << 8) {
        BgAnimStop();
    } else if (func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z, 16, 16, 48)) {
        m4aSongNumStart(0x27F);
    }
    func_08012908();
}
...
void func_08016AF4(s32 x, s32 y, s32 z, u8 f, s32 w) {
    ...
    gUnk_02034928->update = func_08016A64;
    BgAnimSetLoopStartFrame(0);
    FadeToAmount(0, gBtlWork->unk_0B3, 8);
    gUnk_02034928->flags |= 8;
}
...
void func_08016D00(void) {
    ...
    if (gUnk_02034928->unk_08 > 0) {
        if (a > 7) {
            ...
            if (func_08011E3C(gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z,
                              8, 8, 16)) {
                gUnk_02034928->unk_08 = -1;
            } else {
                gUnk_02034928->unk_08--;
            ...
            if (func_08011E3C(gUnk_02034928->x + dx, gUnk_02034928->y,
                              gUnk_02034928->z, 8, 8, 16)) {
                gUnk_02034928->unk_08 = -1;
            }
        }
...
void func_08016F2C(s32 x, s32 y, s32 z, s32 p, s32 q, s32 r, u8 f, s32 w) {
    ...
    m4aSongNumStart(0x29D);
    BgAnimSetLoopStartFrame(8);
    gUnk_02034928->update = func_08016D00;
    gUnk_02034928->unk_28 = p;
    gUnk_02034928->unk_2C = q;
    gUnk_02034928->unk_30 = r;
    gUnk_02034928->unk_08 = 15;
...
void func_08017138(u16 a) {
    ...
    gUnk_02034928->update = func_0801709C;
    BgAnimSetLoopStartFrame(0);
    gUnk_02034928->flags |= 0x10;
}
...
void func_080171FC(u16 a) {
    ...
    gUnk_02034928->update = func_0801718C;
    BgAnimSetLoopStartFrame(0);
    gUnk_02034928->flags |= 0x10;
}
...
void func_08017410(void) {
    ...
    case 1: {
        ...
        func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z, 32, 16, 256);
        t = gUnk_02034928->unk_08;
...
void func_08017514(s32 x, s32 y, s32 z, s32 w) {
    ...
    gUnk_02034928->update = func_08017410;
    FadeToAmount(0, gBtlWork->unk_0B3, 8);
    gUnk_02034928->flags |= 8;
}
void func_080175BC(BtlObj* a, BtlObj* b, u8 c, u8 d) {
    ...
    if (dx >= 0 ? dx <= 0x4FFF : gUnk_02034928->x - b->x <= 0x4FFF) {
        dy = b->y - gUnk_02034928->y;

        if (dy >= 0 ? dy <= 0x27FF : gUnk_02034928->y - b->y <= 0x27FF) {
            if (gUnk_02034928->flags & 1) {
                h = b->unk_0A8 - ((gUnk_02034928->x - b->x) >> 1);
            } else {
                h = b->unk_0A8 + ((gUnk_02034928->x - b->x) >> 1);
            }
...
void func_080177EC(void) {
    ...
    gUnk_02034928->unk_3C = 0;
    func_0801C6D4(&gUnk_02034928->x, &gUnk_02034928->y, &gUnk_02034928->z,
                  &gUnk_02034928->unk_3C);
    ClampBattlePosition(&gUnk_02034928->x, &gUnk_02034928->y, -16, 0);
    func_08012908();
}
void func_080179F8(s32 x, s32 y, s32 z, s32 w, u8 f) {
    ...
    gUnk_02034928->update = func_080177EC;
    BgAnimSetLoopStartFrame(0);
    FadeToAmount(0, gBtlWork->unk_0B3, 8);
    gUnk_02034928->flags |= 8;
}
void func_08017AC0(void) {
    ...
    case 1:
        ...
        if (v > 7) {
#ifdef VERSION_EU
            func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x, gUnk_02034928->y + 0x1000, 0, 0x100, 0x100, 0x100);
#else
            func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x, gUnk_02034928->y + 0x1000, 0, 0x100, 0x100, 8);
#endif
            gUnk_02034928->unk_08 = 0;
            gUnk_02034928->unk_26 = 2;
        } else {
...
void func_08017B74(s32 x, s32 w) {
    ...
    func_08012674();
    gUnk_02034928->x = x;
    gUnk_02034928->y = gBtlWork->unk_0DE << 8;
    gUnk_02034928->z = 0;
    gUnk_02034928->unk_48 = w;
    gUnk_02034928->unk_1C = 10;
    gUnk_02034928->unk_20 = -((gBtlWork->unk_0E0 - gBtlWork->unk_0DE) << 8) / 96;
    WorldToScreen(&sx, &sy, x, gUnk_02034928->y, 0);
    BgAnimStart(&gUnk_09EDAC00, sx, sy);
    gUnk_02034928->flags |= 0x20;
    gUnk_02034928->unk_26 = 0;
    SetBlendAlpha(16, 8);
    gUnk_02034928->update = func_08017AC0;
    BgAnimSetLoopStartFrame(0);
    FadeToAmount(0, gBtlWork->unk_0B3, 8);
    gUnk_02034928->flags |= 8;
}
void func_08017C54(void) {
    switch (gUnk_02034928->unk_26) {
    case 0:
        ApproachValue(&gUnk_02034928->x, gUnk_02034928->unk_28, gUnk_02034928->unk_0A);
    ...
    case 1:
        if (gUnk_02034928->flags & 1) {
            if (func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x - 0x1000, gUnk_02034928->y + 0x2000, 0, 20, 32, 64) || func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x + 0x1000, gUnk_02034928->y - 0x2000, 0, 20, 32, 64)) {
                gUnk_02034928->unk_26 = 2;
                m4aSongNumStart(0x1F9);
            }
        } else if (func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x - 0x1000, gUnk_02034928->y - 0x2000, 0, 20, 32, 64)) {
            gUnk_02034928->unk_26 = 2;
            m4aSongNumStart(0x1F9);
        } else if (func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x + 0x1000, gUnk_02034928->y + 0x2000, 0, 20, 32, 64)) {
            gUnk_02034928->unk_26 = 2;
        ...
        if (gUnk_02034928->flags & 1) {
            if (gBtlWork->actor->x < gUnk_02034928->x) {
                gUnk_02034928->unk_26 = 2;
            }
        } else {
            if (gBtlWork->actor->x > gUnk_02034928->x) {
...
void func_08017E18(s32 x, u8 f, s32 w) {
    ...
    gUnk_02034928->unk_20 = 10;
    gUnk_02034928->flags |= 0x20;
    gUnk_02034928->update = func_08017C54;
    BgAnimSetLoopStartFrame(0);
}
...
void func_08017EF4(void) {
    ...
    if (k <= 4) {
        ...
        if (func_08011F78(0x13D, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z, (s16)t, (s16)t >> 1, 1)) {
...
void func_08017F70(s32 x, s32 y, s32 z, s32 w) {
    ...
    gUnk_02034928->flags |= 0x20;
    gUnk_02034928->update = func_08017EF4;
    FadeToAmount(0, gBtlWork->unk_0B3, 8);
    gUnk_02034928->flags |= 8;
}
...
void func_080180C8(void) {
    ...
    case 1:
        ...
        if (func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z, 0x100, 0x100, 0x100)) {
...
void func_08018184(s32 x, s32 y, s32 z, s32 w) {
    ...
    gUnk_02034928->update = func_080180C8;
    FadeToAmount(0, gBtlWork->unk_0B3, 8);
    gUnk_02034928->flags |= 8;
}
void func_08018240(void) {
    ...
    gUnk_02034928->x = gUnk_02034928->unk_28 + ((gSineTable[gUnk_02034928->unk_24] * gUnk_02034928->unk_3C) >> 8);
    gUnk_02034928->z = gUnk_02034928->unk_30 + ((-gSineTable[gUnk_02034928->unk_24 + 64] * gUnk_02034928->unk_3C) >> 8);

    if (func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z, 10, 5, 72)) {
...
void func_0801836C(s32 x, s32 y, s32 z, s32 w, s32 v) {
    ...
    gUnk_02034928->x = x + ((gSineTable[0] * d) >> 8);
    gUnk_02034928->z = z + ((-gSineTable[64] * d) >> 8);
    gUnk_02034928->y = y;
    gUnk_02034928->unk_20 = 0x180;
    SetBlendAlpha(16, 0);
    ...
    gUnk_02034928->unk_26 = 0;
    gUnk_02034928->update = func_08018240;
    FadeToAmount(0, gBtlWork->unk_0B3, 8);
    gUnk_02034928->flags |= 8;
}
...
void func_080184C4(s32 x, s32 y, s32 z, u8 f) {
    ...
    gUnk_02034928->flags |= 0x20;
    gUnk_02034928->update = func_0801848C;
}
...
void func_080185D0(void) {
    ...
    x = gUnk_02034928->x + gSineTable[ang] * r;
    z = gUnk_02034928->z + -gSineTable[ang + 64] * r;
    y = gUnk_02034928->y;
...
void func_08018724(s32 x, s32 y, s32 z, u8 f, s32 v) {
    ...
    if (gUnk_02034928->flags & 1) {
        if (gUnk_02034928->x < gBtlWork->actor->x) {
            gUnk_02034928->unk_26 = 1;
        } else {
            gUnk_02034928->unk_1C = -(((gUnk_02034928->x - gBtlWork->actor->x) << 8) / 19200);
        }
    } else {
        if (gUnk_02034928->x > gBtlWork->actor->x) {
            gUnk_02034928->unk_26 = 1;
        } else {
            gUnk_02034928->unk_1C = ((gBtlWork->actor->x - gUnk_02034928->x) << 8) / 19200;
        }
    }
    BgAnimSetLoopStartFrame(3);
    gUnk_02034928->update = func_080185D0;
    FadeToAmount(0, gBtlWork->unk_0B3, 8);
    gUnk_02034928->flags |= 8;
}
...
void func_0801884C(void) {
    ...
    if (gUnk_02034928->unk_08 == 10) {
        ...
        if (func_08011F78(gUnk_02034928->unk_48, gUnk_02034928->x, gUnk_02034928->y, gUnk_02034928->z, t, t, 100)) {
...
void func_080188E4(u16 a, s32 x, s32 y, s32 z, s32 w) {
    ...
    gUnk_02034928->update = func_0801884C;
    FadeToAmount(0, gBtlWork->unk_0B3, 8);
    gUnk_02034928->flags |= 8;
}
...
void func_08018C38(s32 x, s32 y, s32 z) {
    ...
    BgAnimStart(&gUnk_09EDAA38, sx, sy);
    BgAnimSetLoopStartFrame(0);
    gUnk_02034928->update = func_08018B78;
...
void func_08018CC4(void) {
    if (gUnk_02034928->unk_08 > 10) {
        switch (gUnk_02034928->unk_26) {
        case 0:
            func_08011F78(11, gUnk_02034928->x - 0x6000, gUnk_02034928->y - 0x1000, gUnk_02034928->z,
                14, 14, 14);
            func_08011F78(11, gUnk_02034928->x, gUnk_02034928->y + 0x2000, gUnk_02034928->z,
                14, 14, 14);
            func_08011F78(11, gUnk_02034928->x + 0x7000, gUnk_02034928->y - 0x1000, gUnk_02034928->z,
                14, 14, 14);
            func_08011F78(11, gUnk_02034928->x - 0x3000, gUnk_02034928->y + 0x2000, gUnk_02034928->z,
                14, 14, 14);
            func_08011F78(11, gUnk_02034928->x + 0x3000, gUnk_02034928->y + 0x2800, gUnk_02034928->z,
                14, 14, 14);
            func_08011F78(11, gUnk_02034928->x - 0x6000, gUnk_02034928->y + 0x6000, gUnk_02034928->z,
                14, 14, 14);
            func_08011F78(11, gUnk_02034928->x + 0x800, gUnk_02034928->y + 0x7800, gUnk_02034928->z,
                14, 14, 14);
            func_08011F78(11, gUnk_02034928->x + 0x3000, gUnk_02034928->y + 0x2800, gUnk_02034928->z,
                14, 14, 14);
            func_08011F78(11, gUnk_02034928->x + 0x6800, gUnk_02034928->y + 0x6800, gUnk_02034928->z,
                14, 14, 14);
            break;
        case 1:
            func_08011F78(11, gUnk_02034928->x + 0x6000, gUnk_02034928->y - 0x1000, gUnk_02034928->z,
...
void func_08018F28(s32 x, s32 y, s32 z) {
    ...
    gUnk_02034928->update = func_08018CC4;
}
