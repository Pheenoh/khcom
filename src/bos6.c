...
void func_0810A51C(PcWork* work, TaskPool* pool) {
    if ((s32)pool > 0x01FFFFFF) {
        gBtlWork->actor->unk_004 = 0xFE00;
        gBtlWork->actor->unk_008 = 0x15D00;
...
void task_bos_pc_0(PcWork* work, s32 arg) {
    ...
    work->unk_198 |= 4;
    func_0801BDD4(q, p);
    ColliderInit(&work->unk_274, 8, 32, 56);
...
u8 func_0810A9CC(PcWork* work, s32 arg) {
    ...
    p = (PcPos*)&work->unk_054;
    if (work->unk_002 == 0) {
        x = gBtlWork->actor->unk_004 >> 8;
        y = gBtlWork->actor->unk_008 >> 8;
        if (x <= 0x109) {
        ...
        case 3:
            ...
            break;
        case 4:
            dx = (gBtlWork->actor->unk_004 >> 8) - 128;
            idx = 0;
            if (dx > 68) {
                if (dx <= 137) {
                    idx = 1;
            ...
            dy = (gBtlWork->actor->unk_008 >> 8) - 0x126;
            if (dy > 29) {
                if (dy <= 59) {
                    idx += 3;
                } else {
...
u8 task_bos_pc_1(PcWork* work, s32 arg) {
    ...
    func_0810A850(work);
    ColliderSetPosition(p->unk_40, p->unk_04, p->unk_08, p->unk_0C);
...
void task_bos_pc_3(PcWork* work) {
    ...
    ColliderUnregister(&work->unk_274);
...
void func_0810B378(void** p, u8 a) {
    ...
    ColliderSetDisabled(&work->unk_010, a);
    if (a == 0) {
        if (work->tiles == 0) {
...
void task_bos_pc_fld_3(PcFldWork* work) {
    ...
    ColliderUnregister(&work->unk_010);
...
void func_0810BCD4(PcFltWork* work) {
    ...
    p = &work->unk_040;
    ColliderSetPosition(p, work->unk_028, work->unk_02C + 0x200, 0);
...
void task_bos_pc_flt_0(PcFltWork* work, PcFltInit* arg) {
    ...
    AnimStart(anim, 1, 0);
    ColliderInit(&work->unk_040, 7, 26, 4);
    work->unk_000 = 0;
    work->unk_002 = 0;
...
void task_bos_pc_acd_2(PcAcdWork* work) {
    ...
    if (flt->unk_004 == 1) {
        ...
        anim = &work->anim;
        if (AnimGetId(anim) == 1) {
            (*gp)->actor->unk_034 |= 0x2000000;
            if ((*gp)->actor->unk_034 & 0x80) {
                return;
            }
            tbl = (u8*)gUnk_09EFAB68;
            ...
            DrawSprite(sx, sy, AnimGetGfx(anim), (void*)work->tiles, (void*)work->palette, 0, GetBattleSpritePriorityFlags((*gp)->actor->unk_008),
                       (u16)(-0x1004 - (((*gp)->actor->unk_008 >> 8) << 2)));
        }
    }
}
...
void func_0810CD00(BosLstWork* work) {
    ...
    if (work->unk_07C < 0) {
        ...
        if (((*pp)->unk_068 & 0x20000000) == 0) {
            work->unk_084 = -0x1200;
            work->unk_088 = (*pp)->actor->unk_004 - ((work->unk_012 * 5) << 10);
    ...
    case 4:
        ...
        if (work->unk_068 > 59) {
            ...
            if (work->unk_0AA >= n) {
                work->unk_0A8 = 5;
                work->unk_068 = 0;
                if (gBtlWork->actor->unk_004 < 0xF800) {
...
s32 func_0810D70C(BosLstWork* work) {
    ...
    r = base + 0x1A00;
    d = abs((gBtlWork->actor->unk_004 - work->unk_044) >> 8);
    if (d > 23) {
        if (d <= 83) {
            r -= (d / 3) << 8;
        } else if (d <= 143) {
    ...
    case 1:
        ...
        if (work->unk_06E > 0x4AF ||
            (work->unk_0D4 == 1 && (gBtlWork->unk_068 & 0x2000000000000) == 0 &&
             gBtlWork->actor->unk_00C > work->unk_04C + work->unk_058 + 0x1800)) {
            func_0810D478(work);
            work->unk_0D6 += 1;
        }
...
u8 func_0810DC28(BosLstWork* work) {
    ...
    case 4:
        work->unk_068 += 1;
        if (work->unk_068 <= 19) {
            if (func_08011F78(268, gBtlWork->actor->unk_004,
                              gBtlWork->actor->unk_008, 0,
                              32, 32, (s16)(((v * 8) >> 8) + 8)) != 0) {
...
u8 func_0810DE04(BosLstWork* work) {
    ...
    case 1:
        ...
        if (work->unk_04C < -0x1E000) {
            *p8C = 3;
            ...
            if (gBtlWork->actor->unk_004 > 0xF7FF) {
            ...
            work->unk_09C = gBtlWork->actor->unk_004 + work->unk_012 * 0x3000;
    ...
    case 2:
        ...
        *p8C = 3;
        work->unk_068 = z;
        work->unk_09C = gBtlWork->actor->unk_004;
        work->unk_0A0 = 0x1F000;
        work->unk_0A4 = -0x5400;
        break;
    case 3:
        if (work->unk_068 <= 7) {
            ApproachValueHalfSteps(&work->unk_09C, gBtlWork->actor->unk_004 + work->unk_012 * 0x3000, 8);
        }
        if (work->unk_068 == 0) {
            work->unk_0A0 = func_0810CC14(work->unk_0A0, gBtlWork->actor->unk_008, 0x100, 0x100, 0x100);
        }
...
u8 task_bos_lst_1(BosLstWork* work) {
    ...
    *(s32*)&work->unk_018 = (work->unk_110 * 255) / work->unk_112;
    ...
    ColliderSetPosition(obj->unk_40, obj->unk_04 + (work->unk_012 << 10), obj->unk_08, obj->unk_0C);
    ColliderSetPosition(work->unk_474, obj->unk_04, obj->unk_08 - 0x1000, obj->unk_0C + 0x1800);
    ColliderSetPosition(&work->unk_4D0, obj->unk_04, obj->unk_08 - 0x1000, obj->unk_0C + 0x4000);
    for (i = 0; i < 8; i++) {
