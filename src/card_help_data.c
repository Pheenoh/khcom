...
const CardHelpDef gUnk_0903BD0C __attribute__((section(".data_card_help_def_0903BD0C"))) = {
    gUnk_09EE7A38,
    2,
    { 0, 0, 0 },
};
...
#if defined(VERSION_JP)
const CardHelpDef gUnk_0903BD14 __attribute__((section(".data_card_help_def_0903BD14"))) = {
    gUnk_09EE7A40,
    2,
    { 0, 0, 0 },
};
