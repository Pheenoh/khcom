...
void task_poo_pooh_0(PooWork* w) {
    ...
    ColliderSetPosition(w->unk_4C, w->unk_28.x, w->unk_28.y, w->unk_28.z);
...
u8 func_080C871C(PooWork* w) {
    if (gUnk_0203C3F0 == 1) {
        func_080C84E0(w, 16);
        w->unk_28.x = gUnk_0203C3DC;
        w->unk_28.y = gUnk_0203C3E8;
        ...
        w->unk_38 = GetAngle(w->unk_28.x, w->unk_28.y, gUnk_0203C3DC, gUnk_0203C3E8);
        w->unk_3A = w->unk_38;
        w->unk_3B = w->unk_38;
        func_080C84E0(w, 20);
...
void func_080C88C4(PooWork* w, PooNode* n) {
    if (n != 0) {
        ...
        if (w->unk_D0 != n && w->unk_D4 <= 59) {
            w->unk_3A = w->unk_38;
            w->unk_3B = w->unk_38;
            w->unk_39 = GetAngle(w->unk_28.x, w->unk_28.y, ((PooPos*)n->unk_08)->x, ((PooPos*)n->unk_08)->y);
            w->unk_40 = w->unk_28.x;
            w->unk_44 = w->unk_28.y;
            func_080C84E0(w, 9);
        } else {
...
void func_080C89B4(PooWork* w, PooSpot* b, u16 c) {
    ...
    w->unk_28.z += b[w->unk_A8 * c + f].unk_08;
}
...
void func_080C8C40(PooWork* w, PooNode* n) {
    ...
    case 12:
        a0 = w->unk_3A;
        w->unk_39 = GetAngle(w->unk_28.x, w->unk_28.y, 0x8DE00, 0x45C00);
    ...
    case 5:
        ...
        if (func_080C83C4(w->unk_40 >> 8, w->unk_44 >> 8, w->unk_28.x >> 8, w->unk_28.y >> 8) == 0) {
            break;
        }
        func_080C84E0(w, 6);
        break;
    ...
    case 9:
        if (w->unk_D4 <= 59) {
            a1 = w->unk_3A;
            w->unk_39 = GetAngle(w->unk_28.x, w->unk_28.y, ((s32*)n->unk_08)[0], ((s32*)n->unk_08)[1]);
    ...
    case 16:
        ...
        if (w->unk_28.x == 0x4A700 && w->unk_28.y == 0x28E00 && func_080D2D50(5) == 0) {
            func_080C84E0(w, 37);
    ...
    case 38:
        ...
        if (w->unk_AC > 80 && w->unk_28.z >= -0x800 && IsTaskActive(w->unk_C4) != 0) {
    ...
    case 21:
        ...
        if (w->unk_F6 == 0) {
            func_080D0084((u32*)&w->unk_28.x, (u32*)&w->unk_28.y, 1);
            break;
        }

        while ((u8)func_080CFEA0(&w->unk_28) != 0) {
            w->unk_28.x += gSineTable[w->unk_38] * 2;
            w->unk_28.y -= gSineTable[w->unk_38 + 0x40] * 2;
        }
        break;
    case 2:
        w->unk_28.z += w->unk_48;
    ...
    case 7:
        if (w->unk_E8 != 0) {
            w->unk_40 = gUnk_0203C420.unk_00.x;
            w->unk_44 = gUnk_0203C420.unk_00.y;
            func_080C8B60((PooMover*)w, 76, 1);
            break;
        }
        w->unk_40 = gUnk_0203C420.unk_00.x;
        w->unk_44 = gUnk_0203C420.unk_00.y;
        w->unk_38 = GetAngle(w->unk_28.x, w->unk_28.y, w->unk_40, w->unk_44);
        w->unk_48 = -0x130;
        w->unk_3C = 237;
        func_080C84E0(w, 19);
        break;
    case 19:
        if (AnimIsFinished((AnimState*)w->unk_0C) != 0 && w->unk_E8 != 0 && w->unk_28.z < -0x100) {
            func_080C84E0(w, 8);
            func_080C8AE0(w);
            break;
        }
        ...
        if ((AnimGetFrame((AnimState*)w->unk_0C) > 1 && AnimGetFrame((AnimState*)w->unk_0C) <= 4) ||
            (AnimGetFrame((AnimState*)w->unk_0C) > 4 && w->unk_E8 == 0 && w->unk_28.z < w->unk_EC)) {
            w->unk_28.x += gSineTable[w->unk_38] * w->unk_3C >> 8;
            w->unk_28.y += -gSineTable[w->unk_38 + 0x40] * w->unk_3C >> 8;
        }
...
void task_poo_pooh_2(PooWork* w) {
    ...
    x = (w->unk_28.x >> 8) - gUnk_0203C40C;
    y = (w->unk_28.y >> 8) + (w->unk_28.z >> 8) - gUnk_0203C3F8;
    if (w->unk_24 != 0) {
        f = 0x801;
    } else {
        f = 0x800;
    ...
    if (gUnk_02034DAC == 20 && w->unk_A8 == 1) {
        ...
        if (gUnk_02034DAC == 21 && w->unk_A8 == 1 && w->unk_F6 != 0) {
            ...
            if (gUnk_0203C3EC->y < gUnk_0203C420.unk_00.y) {
                p = func_080D06C8() + 5;
            } else {
                p = func_080D06C8() + 1;
            }
        ...
        if (w->unk_28.y >= gUnk_0203C420.unk_00.y) {
            p -= 2;
        } else {
            p += 2;
        }
...
void func_080CAB24(PooActor* p) {
    ...
    case 0x2D:
    case 0xD3:
        x = p->unk_00.x + gSineTable[p->unk_14] * 12;
        y = p->unk_00.y + -gSineTable[p->unk_14 + 0x40] * 12;
        break;
    case 0x40:
    case 0xC0:
        x = p->unk_00.x + gSineTable[p->unk_14] * 27;
        y = p->unk_00.y + -gSineTable[p->unk_14 + 0x40] * 27;
        break;
    case 0x00:
    case 0x53:
    case 0x80:
    case 0xAD:
    default:
        x = p->unk_00.x + gSineTable[p->unk_14] * 20;
        y = p->unk_00.y + -gSineTable[p->unk_14 + 0x40] * 20;
        break;
    }
    func_080C7684(x, y, p->unk_00.z - 0x800);
}
...
void task_poo_sora_0(PooSoraWork* w) {
    ...
    a->unk_00.unk_0C = 0;
    a->unk_10 = 0;
    func_080C9FA8(a->unk_00.x, a->unk_00.y + a->unk_00.z);
    ...
    ColliderSetPosition(w->unk_38, a->unk_00.x, a->unk_00.y, a->unk_00.z);
}
...
u8 func_080CAD08(PooSoraWork* w, u8* t) {
    ...
    case 7:
        ...
        a->unk_00.x += gSineTable[a->unk_14] * a->unk_10 >> 8;
        a->unk_00.y += -gSineTable[a->unk_14 + 0x40] * a->unk_10 >> 8;
    ...
    if ((u8)func_080CFE34(&a->unk_00) != 0) {
        if (a->unk_00.z > -0xA00) {
            ...
            if ((u8)func_080CFE34(&p) == 0) {
                ...
                a->unk_10 = 0;
                v = (-a->unk_00.z >> 8) + 1;
                func_080CFF58((u32*)&a->unk_00, (u32*)&a->unk_00.y, v);
            }
        }
    }
    ColliderSetPosition(w->unk_38, a->unk_00.x, a->unk_00.y, a->unk_00.z);
...
void task_poo_sora_2(PooSoraWork* w) {
    ...
    if (ac != 0) {
        ...
        gUnk_02034DEC = -0x1008 - (a->unk_00.y >> 8) * 4;
        a->unk_3C = 0;
    ...
    x = (a->unk_00.x >> 8) - gUnk_0203C40C;
    y = (a->unk_00.y >> 8) + (a->unk_00.z >> 8) - gUnk_0203C3F8;
...
void task_poo_trap_0(PooTrapWork* w, PooPos* p) {
    ...
    w->gfx = gUnk_0972BD78;
    ColliderSetPosition(w->unk_1C, w->x, w->y, w->z);
    w->unk_8C = 0;
}

u8 task_poo_trap_1(PooTrapWork* w) {
    if (w->unk_8C != 0) {
        if (ColliderIsTouchingType(w->unk_1C, 9) != 0) {
            gUnk_0203C3DC = w->x;
            gUnk_0203C3E8 = w->y;
            gUnk_0203C3F0 = 1;
        }
...
void task_poo_trap_2(PooTrapWork* w) {
    ...
    if (x < -16 || x > 256 || y < -16 || y > 176) {
        if (w->unk_8C != 0) {
            ColliderUnregister(w->unk_1C);
            w->unk_8C = 0;
        }
    } else {
        if (w->unk_8C == 0) {
            ColliderInit(w->unk_1C, 10, 8, 16);
            w->unk_8C = 1;
        }
...
void task_poo_pitAndButterfly_0(PooTrapWork* w, PooPos* p) {
    ...
    TaskCreate(&w->unk_78, &gTaskDescPooButterfly, &w->x);
    func_080CCB90(&w->unk_90, 0xE10, &w->x);
}
...
void task_poo_balloon_2(PooBalloonObjWork* w) {
    ...
    if (x >= -16 && x <= 256 && y >= -16 && y <= 176) {
        ...
        DrawSprite(x, y, w->gfx, w->tiles, w->palette, 0, 0x800, -0x1004 - (w->unk_24->y >> 8) * 4);
    }
}
...
void task_poo_trapballoon_0(PooBalloonWork* w, PooPos* p) {
    ...
    w->unk_C8 = 0;
    w->unk_CE = GetRandom();
    ColliderSetPosition(w->unk_34, w->unk_24.x, w->unk_24.y, w->unk_24.z);
}
...
u8 task_poo_trapballoon_1(PooBalloonWork* w) {
    ...
    if (ColliderIsTouchingType(w->unk_34, 9) != 0 && func_080C9D70() != 0) {
        gUnk_0203C3DC = w->unk_24.x;
        gUnk_0203C3E8 = w->unk_24.y;
        gUnk_0203C3F0 = 2;
    ...
    if (gUnk_0203C3D8 == 0) {
        if (ColliderIsTouchingType(w->unk_34, 9) == 0) {
            return 1;
        }
    ...
    func_080CCB84(&w->unk_90, 0);
    ColliderSetDisabled(w->unk_34, 1);
    func_08000DE8(&w->unk_B0, w->unk_C4);
    w->unk_24.x -= 0x800;
    w->unk_24.y += 0x1000;
...
void task_poo_trapballoon_2(PooBalloonWork* w) {
    ...
    if (IsTaskActive((Task*)w->unk_C8) != 0) {
        ...
        x = ((w->unk_24.x - 0x800) >> 8) - gUnk_0203C40C;
        d += 0x1200;
        y = ((w->unk_24.y + d) >> 8) + (w->unk_24.z >> 8) - gUnk_0203C3F8;
...
u8 task_poo_owlballoon_1(PooOwlBalloonWork* w) {
    if (w->palette != 0 && ColliderIsTouchingType(w->unk_34, 9) != 0 && func_080C9D70() != 0) {
        gUnk_0203C3DC = w->unk_24.x;
        gUnk_0203C3E8 = w->unk_24.y;
        gUnk_0203C3F0 = 7;
        func_080CCB84(&w->unk_90.unk_00, 0);
...
void task_poo_owlballoon_2(PooOwlBalloonWork* w) {
    ...
    w->gfx = AnimUpdate(w->anim);
    x = ((w->unk_24.x - 0x800) >> 8) - gUnk_0203C40C;
    y = ((w->unk_24.y + 0x1000) >> 8) - gUnk_0203C3F8;
    if (IsRectOutsideScreen(x, y, 64, 8, 24, 24) != 0) {
        if (w->palette != 0) {
            ReleaseObjTiles(w->tiles);
            ReleaseObjPalette(w->palette);
        ...
        DrawSprite(x, y, w->gfx, w->tiles, w->palette, 0, 0x800, -0x1003 - (w->unk_24.y >> 8) * 4);
        TaskPoolUpdate(&w->unk_B0);
        TaskPoolDraw(&w->unk_B0);
    }
}
...
void task_poo_honey_0(PooHoneyWork* w, PooPos* p) {
    ...
    ColliderSetPosition(w->unk_74, w->unk_24.x, w->unk_24.y, w->unk_24.z);
    w->unk_34 = w->unk_24;
    w->unk_34.x += 0xB00;
    w->unk_34.y -= 0xA00;
    w->unk_54 = w->unk_34;
...
void task_poo_pile_0(PooPileWork* w, PooPileArgs* a) {
    ...
    w->gfx = AnimGetGfx(w->anim);
    ColliderSetPosition(w->unk_34, w->x, w->y, w->z);
    w->unk_CC = 0;
...
void task_poo_pile_2(PooPileWork* w) {
    ...
    if (x < -16 || x > 256 || y < -36 || y > 196) {
        ...
        if (w->unk_B0 != 7) {
            ...
            if (w->unk_CC == 0) {
                ColliderInit(w->unk_34, 7, 4, (u16)func_080CD1F8(w->unk_B0));
                func_080CCB90(&w->unk_90, 0x240, &w->x);
                w->unk_CC = 1;
            }
        } else {
            z = 0xFFF1;
...
void task_poo_tigerstump_0(PooStumpWork* w, PooPos* p) {
    ...
    w->palette = 0;
    w->gfx = gUnk_097561D4;
    ColliderSetPosition(w->unk_34, w->unk_24, w->unk_28, 0);
}
...
void task_poo_piglet_0(PooPigletWork* w) {
    ...
    TaskCreate(&w->unk_94, &gTaskDescPooShadow, &w->x);
...
u8 task_poo_piglet_1(PooPigletWork* w) {
    if (w->palette != 0 && w->unk_38[0x2C] != 0) {
        if (ColliderIsTouchingType(w->unk_38, 9) == 0) {
            return 1;
        }
...
void task_poo_piglet_2(PooPigletWork* w) {
    ...
    if (IsRectOutsideScreen(x, y, 24, 8, 8, 8) != 0) {
        ...
        if (w->palette == 0) {
            ...
            if (func_080D2D50(0) != 0) {
                ColliderInit(w->unk_38, 10, 4, 16);
            } else {
                ColliderInit(w->unk_38, 10, 16, 16);
            }
...
void task_poo_eeyore_0(PooEeyoreWork* w) {
    ...
    TaskCreate(&w->unk_90, &gTaskDescPooShadow, &w->x);
    ColliderInit(w->unk_34, 10, 16, 16);
    ColliderSetPosition(w->unk_34, w->x, w->y, w->z);
    w->unk_AC = 1;
    ...
    if (func_080C9D5C() != 0) {
        ...
        if (func_080C9910() != 0) {
            ...
            if (AnimGetFrame(w->unk_0C) > 3) {
                if (w->unk_4A != 0) {
                    ApproachValueHalfSteps(&w->unk_24.z, -0x9000, w->unk_4A);
                    w->unk_4A--;
                    w->unk_24.x -= 204;
                } else {
                    w->unk_24.z -= 0x100;
...
void task_poo_owl_2(PooOwlWork* w) {
    ...
    if (IsRectOutsideScreen(x, y, 24, 8, 8, 8) != 0) {
        ...
        DrawSprite(x, y, w->gfx, w->tiles, w->palette, 0, 0x800, -0x1004 - ((w->unk_24.y + w->unk_24.z) >> 8) * 4);
    }
}
...
void task_poo_rabbit_0(PooRabbitWork* w) {
    ...
    func_080CC178(&w->unk_38, &w->x, 0x100);
    ColliderSetPosition(w->unk_4C, w->x, w->y, w->z);
...
u8 task_poo_rabbit_1(PooRabbitWork* w) {
    ...
    case 1:
        ...
        break;
    case 4:
        if (w->palette != 0 && w->unk_4C[0x2C] != 0 && ColliderIsTouchingType(w->unk_4C, 9) != 0) {
            func_080CE2C4(w, 6, 0);
            w->unk_B0 = 20;
        } else {
    ...
    case 6:
        if (w->unk_B0 == 0) {
            if (w->palette != 0 && ColliderIsTouchingType(w->unk_4C, 9) == 0) {
                func_080CE2C4(w, 4, 1);
            }
        } else {
            w->unk_B0--;
    ...
    case 0:
        if (w->unk_B0 != 0) {
            w->unk_B0--;
        } else if (w->palette != 0 && ColliderIsTouchingType(w->unk_4C, 9) == 0) {
            func_080CE2C4(w, 2, 1);
        }
        break;
    default:
...
void task_poo_roo_0(PooRooWork* w, PooPos* p) {
    ...
    ColliderInit(w->unk_3C, 10, 4, 32);
    ColliderSetPosition(w->unk_3C, w->unk_28.x, w->unk_28.y, w->unk_28.z);
...
u8 task_poo_roo_1(PooRooWork* w) {
    ...
    case 2:
        ...
        break;
    case 3:
        if (ColliderIsTouchingType(w->unk_3C, 9) != 0) {
            gUnk_0203C3F0 = 5;
        }
        break;
    }
...
void task_poo_roo_2(PooRooWork* w) {
    ...
    x = (w->unk_28.x >> 8) - gUnk_0203C40C;
    t = w->unk_28.y >> 8;
    y = t + (w->unk_28.z >> 8) - gUnk_0203C3F8;
    pr = w->unk_24 != 0 ? 0x801 : 0x800;
...
void task_poo_honeycomb_0(PooHoneycombWork* w) {
    ...
    w->palette = 0;
    w->gfx = gUnk_097567FC;
    ColliderSetPosition(w->unk_38, w->unk_24, w->unk_28, 0);
    w->unk_9C = 0;
    gUnk_02034E1C = 0;
    w->unk_98 = 0;
    w->unk_96 = 0;
...
void task_poo_vegetable_2(PooVegetableWork* w) {
    ...
    if (IsRectOutsideScreen(x, y, 32, 40, 48, 48) != 0) {
        ...
        if (w->palette == 0) {
            ...
            ColliderInit(w->unk_38, 7, 0x26, 12);
        }
        DrawSprite(x, y, w->gfx, w->tiles, w->palette, 0, 0x800, -0x1004 - (w->y >> 8) * 4);
    }
}
...
u8 func_080CFF30(void) {
    if (gUnk_0203C420.unk_00.z < -0x2000) {
        return 0;
    }
    return func_080CFE34(&gUnk_0203C420.unk_00);
}
...
void task_poo_wagon_2(PooCamera* w) {
    ...
    if (func_080CFF30() != 0) {
        ...
        if (func_080C9DAC() != 0) {
            if (gUnk_0203C420.unk_00.y >= gUnk_0203C3EC->y) {
                gUnk_02034E26 += 6;
            } else {
        ...
        d = (u8)func_080D0210(gUnk_0203C420.unk_00.x, gUnk_0203C420.unk_00.y);
...
void task_poo_spark_2(PooSparkWork* w) {
    ...
    x = (w->unk_00.x >> 8) - gUnk_0203C40C;
    y = (w->unk_00.y >> 8) + (w->unk_00.z >> 8) - gUnk_0203C3F8;
...
void task_poo_cabbage_0(PooCabbageWork* w) {
    ...
    w->gfx = AnimGetGfx(w->anim);
    ColliderInit(w->unk_44, 10, 8, 16);
    ColliderSetPosition(w->unk_44, w->x, w->y, w->z);
    w->unk_D0 = 1;
    TaskPoolInit(&w->unk_A8, 2);
    func_080CC178(&w->unk_A8, &w->x, 0x80);
    w->unk_BC = 0;
    w->unk_CE = 0;
    w->unk_D1 = 0;
    w->unk_D2 = 1;
...
u8 task_poo_cabbage_1(PooCabbageWork* w) {
    ...
    case 2:
        if (gUnk_0203C3D8 != 0 && func_080C76B0(w->unk_44) != 0) {
            ...
            w->unk_BC = TaskCreate(&w->unk_A8, &gTaskDescPooSpark, &w->x);
            w->unk_A4 = 3;
...
void func_080D19C4(PooPrizeWork* w) {
    ...
    if (w->unk_10[0x2C] != 0 && ColliderIsTouchingType(w->unk_10, 1) != 0) {
        switch (w->unk_80) {
        case 2:
        case 3:
            m4aSongNumStart(107);
        ...
        w->unk_82 = 0;
        w->unk_8C = GetAngle(gUnk_0203C420.unk_00.x, gUnk_0203C420.unk_00.y, w->x, w->y);
        w->unk_97 = 1;
        w->unk_96 = 1;
        w->unk_8D = GetRandom() % 6 + 5;
        ColliderSetDisabled(w->unk_10, 1);
    } else {
        ColliderSetPosition(w->unk_10, w->x, w->y, w->z);

        if (w->unk_82 == 20) {
            ColliderSetDisabled(w->unk_10, 0);
        }
...
void task_poo_rabbitAfterEvent_0(PooRabbitAfterEventWork* w) {
    ...
    w->gfx = AnimGetGfx(w->anim);
    TaskPoolInit(&w->unk_34, 1);
    func_080CC178(&w->unk_34, &w->x, 0x100);
    ColliderSetPosition(w->unk_48, w->x, w->y, w->z);
...
u8 task_poo_rabbitAfterEvent_1(PooRabbitAfterEventWork* w) {
    if (w->palette != 0) {
        if (ColliderIsTouchingType(w->unk_48, 9) != 0) {
            gUnk_0203C3F0 = 5;
        }
    }
    return 1;
...
TaskDesc gUnk_09EF48E0 __attribute__((section(".data_registration_gUnk_09EF48E0"))) = {
    gTaskName_09EF48E0,
...
TaskDesc gUnk_09EF48F8 __attribute__((section(".data_registration_gUnk_09EF48F8"))) = {
    gTaskName_09EF48F8,
...
TaskDesc gUnk_09EF49A0 __attribute__((section(".data_registration_gUnk_09EF49A0"))) = {
    gTaskName_09EF49A0,
...
TaskDesc gUnk_09EF49D0 __attribute__((section(".data_registration_gUnk_09EF49D0"))) = {
    gTaskName_09EF49D0,
...
TaskDesc gUnk_09EF4A18 __attribute__((section(".data_registration_gUnk_09EF4A18"))) = {
    gTaskName_09EF4A18,
...
TaskDesc gUnk_09EF4A30 __attribute__((section(".data_registration_gUnk_09EF4A30"))) = {
    gTaskName_09EF4A30,
...
TaskDesc gUnk_09EF4B38 __attribute__((section(".data_registration_gUnk_09EF4B38"))) = {
    gTaskName_09EF4B38,
...
TaskDesc gUnk_09EF4CF0 __attribute__((section(".data_registration_gUnk_09EF4CF0"))) = {
    gTaskName_09EF4CF0,
    (void (*)(void*, void*))task_poo_butterfly_0,
...
TaskDesc gUnk_09EF4D08 __attribute__((section(".data_registration_gUnk_09EF4D08"))) = {
    gTaskName_09EF4D08,
    (void (*)(void*, void*))task_poo_butterfly_0,
...
TaskDesc gUnk_09EF4D38 __attribute__((section(".data_registration_gUnk_09EF4D38"))) = {
    gTaskName_09EF4D38,
...
TaskDesc gUnk_09EF4D68 __attribute__((section(".data_registration_gUnk_09EF4D68"))) = {
    gTaskName_09EF4D68,
