...
u8 func_080F8958(GaWork* work) {
    ...
    case 1:
        ...
        dx = gBtlWork->actor->unk_004 - gBtlWork->unk_0CC;
        dx = (dx * dx) >> 8;
        dy = gBtlWork->actor->unk_008 - gBtlWork->unk_0D0;
        dy = (dy * dy) >> 8;
        d = (dx + dy) >> 8;
        if (d <= 0xE0F) {
            if (work->unk_A4C == 0) {
...
u8 func_080F8AC8(GaWork* work) {
    ...
    for (i = 0; i <= 5; i++) {
        ...
        case 0: {
            ...
            x = gBtlWork->actor->unk_004;
            y = gBtlWork->actor->unk_008;
            if (work->unk_A4C == 0) {
                if (x > e->unk_124) {
                    x -= 0x2800;
                    if (x < 0) {
        ...
        case 2:
            for (i = 0; i <= 5; i++) {
                ...
                case 0:
                    ...
                    work->unk_A40 = 1024;
                    work->unk_A44 = work->unk_A40 * 2 / work->unk_010;
                    work->unk_01C = func_080F7E0C(e->unk_124, e->unk_128, gBtlWork->actor->unk_004, gBtlWork->actor->unk_008);
                    work->unk_00C = 3;
                    break;
                }
            }
...
u8 func_080F9C2C(GaWork* work) {
    ...
    case 1:
        ...
        case 1:
            gBtlWork->unk_0D4 = 0;
            work->unk_A38 = (gBtlWork->actor->unk_004 - gBtlWork->unk_0CC) / 60;
            work->unk_A3C = (gBtlWork->actor->unk_008 - gBtlWork->unk_0D0) / 60;
            work->unk_A40 = 0x600;
            work->unk_00C = 2;
            break;
        case 2:
...
u8 func_080F9EDC(GaWork* work) {
    ...
    case 1:
        ...
        case 1:
            ...
            break;
        case 2:
            work->unk_01C = func_080F7E0C(gBtlWork->unk_0CC, gBtlWork->unk_0D0, gBtlWork->actor->unk_004, gBtlWork->actor->unk_008);
