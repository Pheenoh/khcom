...
void func_08078E34(UnkStruct_08080268* w, u8 b, u8 c) {
    ...
    while (p != 0) {
        ...
        p = (CardDisplayWork*)ListPoolNext(&p->unk_64);
    }
    ...
    if (gBtlWork->unk_068 & 0x4800) {
        ...
        if (gUnk_02039B9C->unk_0F4 == 29) {
            for (k = 0; k < gUnk_02039DD4->unk_0D0; k++) {
                if (gUnk_02039DD4->unk_000[k]->unk_48->unk_2A == 2 &&
                    !(gUnk_02039DD4->unk_000[k]->unk_48->unk_1E & 8)) {
                    skip = 1;
                }
            }
        }
...
s32 func_08079600(UnkStruct_08080268* w) {
    ...
    while (e != 0) {
        ...
        e = (CardDisplayWork*)ListPoolNext(&e->unk_64);
    }
...
s32 func_08079B3C(UnkStruct_08080268* w) {
    ...
    if (gUnk_02039DD4->unk_0CC == 0) {
        gUnk_02039DD4->unk_0CC = gUnk_02034A98->unk_48->unk_24;
        func_0807B458(w, gUnk_02039DD4->unk_0CC);
...
s32 func_0807A188(UnkStruct_08080268* w) {
    ...
    if ((u16)(gUnk_02034A98->unk_48->unk_1E & 0x10)) {
        m4aSongNumStart(105);
        return 1;
    }
...
void func_0807BEC0(CardDisplayWork* p) {
    ...
    if (!(p->unk_78 & 0x200)) {
        ...
        DrawSprite(p->unk_4C >> 8, y, gUnk_08F709B0[p->unk_48->unk_2A].unk_00, ((struct UnkStruct_0807BEC0*)gUnk_02039DD4)->tiles[p->unk_48->unk_2A], gUnk_02039DD4->palette, aff, attr, (u16)(p->unk_A0 - 1));
        DrawSprite(p->unk_4C >> 8, y, gfx, p->tiles, p->palette, aff, attr, p->unk_A0);
        j = p->unk_A5;
        ...
        if (p->unk_A7 != 0) {
            DrawSprite(p->unk_4C >> 8, y, gUnk_09EE98C0[j], gUnk_02039DD4->tiles7, gUnk_02039DD4->palette2, aff, attr, (u16)(p->unk_A0 - 2));
        } else if (p->unk_A6 != 0) {
            DrawSprite(p->unk_4C >> 8, y, gUnk_09EE9894[j], gUnk_02039DD4->tiles6, gUnk_02039DD4->palette2, aff, attr, (u16)(p->unk_A0 - 2));
        } else {
            DrawSprite(p->unk_4C >> 8, y, gUnk_09EE981C[j], gUnk_02039DD4->tiles5, gUnk_02039DD4->palette, aff, attr, (u16)(p->unk_A0 - 2));
        }

        if (p->unk_A6 != 0) {
            DrawSprite(p->unk_4C >> 8, y, gUnk_02039DD4->gfx, gUnk_02039DD4->unk_040, gUnk_02039DD4->palette, aff, attr, (u16)(p->unk_A0 - 3));
        }
    ...
    DrawSprite(p->unk_4C >> 8, y, p->unk_48->unk_10, p->tiles, p->palette, aff, attr, p->unk_A0);
    k = p->unk_A5;
    ...
    if (p->unk_A7 != 0) {
        DrawSprite((p->unk_4C >> 8) - 3, y - 4, gUnk_09EE981C[k], gUnk_02039DD4->tiles7, gUnk_02039DD4->palette2, aff, attr, (u16)(p->unk_A0 - 10));

        if (p->unk_A6 != 0) {
            DrawSprite(p->unk_4C >> 8, y, gUnk_02039DD4->gfx2, gUnk_02039DD4->unk_050, gUnk_02039DD4->palette, aff, attr, (u16)(p->unk_A0 - 11));
        }
    } else if (p->unk_A6 != 0) {
        DrawSprite((p->unk_4C >> 8) - 3, y - 4, gUnk_09EE981C[k], gUnk_02039DD4->tiles6, gUnk_02039DD4->palette2, aff, attr, (u16)(p->unk_A0 - 10));
        DrawSprite(p->unk_4C >> 8, y, gUnk_02039DD4->gfx2, gUnk_02039DD4->unk_050, gUnk_02039DD4->palette, aff, attr, (u16)(p->unk_A0 - 11));
    } else {
        DrawSprite((p->unk_4C >> 8) - 3, y - 4, gUnk_09EE981C[k], gUnk_02039DD4->tiles5, gUnk_02039DD4->palette, aff, attr, (u16)(p->unk_A0 - 10));
    }
}
...
void card_not_have_2(CardDisplayWork* p) {
    ...
    if (p->unk_78 & 0x80) {
        DrawSprite(p->unk_4C >> 8, y, gfx, p->tiles2, gUnk_02039DD4->palette, 0, 0x410, (u16)(p->unk_A0 - 1));
    }
}
...
void card_reload_2(CardDisplayWork* p) {
    ...
    if (p->unk_78 & 0x80) {
        ...
        attr = 0x410;
        DrawSprite(p->unk_4C >> 8, y, gUnk_08F709B0[3].unk_04, p->tiles2,
                   gUnk_02039DD4->palette, 0, attr, p->unk_A0);

        if (!(gGameState.flags & 8) && *(void**)&w[0x60] != 0) {
            DrawSprite(p->unk_4C >> 8, y, *(void**)&w[0x60], p->tiles,
        ...
        if ((s32)gUnk_02039DD4->unk_0F4 > 0) {
            ...
            if (*(void**)&w[0x58] != 0) {
                DrawSprite(p->unk_4C >> 8, y + 17, *(void**)&w[0x58], p->tiles3,
                           gUnk_02039DD4->palette, affine, 0x400,
                           (u16)(p->unk_A0 - 1));
            }

            if (gUnk_02039DD4->unk_108[0] == 1 && *(void**)&w[0x5C] != 0) {
                DrawSprite(p->unk_4C >> 8, y, *(void**)&w[0x5C], p->tiles4,
...
void func_0807E8F4(UnkStruct_08080268* w) {
    ...
    w->unk_14 = AllocSpriteFrameTiles(0x80);
    w->unk_18 = LoadObjPalette(gUnk_08F69BA4, 32);
    UpdateSpriteFrameTiles((UnkStruct_080038C8*)w->unk_14, gUnk_09EF12E8[0], gUnk_093FBAB8);
...
u8 func_0807EDEC(UnkStruct_08080268* w, void* a) {
    ...
    case 3:
        ...
        if (gUnk_02034AAC->unk_48->unk_2A != 3) {
    ...
    if (w->unk_C0[w->unk_B8] != 0) {
        ...
        if (gUnk_02039B9C->unk_0F4 != 40) {
            if (gUnk_02039B9C->unk_07C->unk_02C > 3) {
                gUnk_02039B9C->unk_07C->unk_02C -= 2;
            }
...
void func_080802D8(UnkStruct_08080268* w) {
    ...
    if (gBtlWork->unk_0F4 == 29) {
        for (j = 0; j < gUnk_02039DD4->unk_0D0; j++) {
            if (gUnk_02039DD4->unk_000[j]->unk_48->unk_2A == 2 && !(gUnk_02039DD4->unk_000[j]->unk_48->unk_1E & 8)) {
                flag = 1;
            }
        }
    }
...
void func_08080EB4(UnkStruct_08080268* w) {
    ...
    skip = 0;
    if (gBtlWork->unk_0F4 == 2 && gUnk_02039DD4->unk_000[0]->unk_48->unk_2A == 0 &&
        gUnk_02039DD4->unk_0E1 == 0) {
        skip = 1;
    }
#ifdef VERSION_EU
...
#else
    if (gBtlWork->unk_0F4 == 20 && gUnk_02039DD4->unk_000[0]->unk_48->unk_24 == 22 &&
        gUnk_02039DD4->unk_0E1 == 0) {
        skip = 1;
    }
    if (gBtlWork->unk_0F4 == 29 && gUnk_02039DD4->unk_000[0]->unk_48->unk_2A == 2 &&
        gUnk_02039DD4->unk_0E1 == 0) {
        skip = 1;
    }
#endif
...
#ifdef VERSION_EU
    if (gUnk_02039B9C->unk_0F4 == 41) {
        if (gBtlWork->unk_0F4 == 47 && (gBtlWork->unk_068 & 0x20000000)) {
            gBtlWork->unk_068 &= ~2;
        }
...
void func_08081C98(CardDisplayWork* p) {
    ...
    if (!(p->unk_78 & 0x200)) {
        ...
        aff = AllocObjAffine(p->unk_5E, p->unk_54, p->unk_58, 0);
        flags = 0x410;
        DrawSprite(p->unk_4C >> 8, y, gUnk_08F709B0[p->unk_48->unk_2A].unk_00, ((UnkStruct_0809B200*)gUnk_02039DD4)->unk_030[p->unk_48->unk_2A], gUnk_02039DD4->palette, aff, flags, (u16)(p->unk_A0 - 1));
        DrawSprite(p->unk_4C >> 8, y, gfx, p->tiles, p->palette, aff, flags, p->unk_A0);
        j = p->unk_A5;
        ...
        if (p->unk_A7 != 0) {
            DrawSprite(p->unk_4C >> 8, y, gUnk_09EE98C0[j], gUnk_02039DD4->tiles7, gUnk_02039DD4->palette2, aff, flags, (u16)(p->unk_A0 - 2));
        } else if (p->unk_A6 != 0) {
            DrawSprite(p->unk_4C >> 8, y, gUnk_09EE9894[j], gUnk_02039DD4->tiles6, gUnk_02039DD4->palette2, aff, flags, (u16)(p->unk_A0 - 2));
        } else {
            DrawSprite(p->unk_4C >> 8, y, gUnk_09EE981C[j], gUnk_02039DD4->tiles5, gUnk_02039DD4->palette, aff, flags, (u16)(p->unk_A0 - 2));
        }

        if (p->unk_A6 != 0) {
            DrawSprite(p->unk_4C >> 8, y, gUnk_02039DD4->gfx, gUnk_02039DD4->unk_040, gUnk_02039DD4->palette, aff, flags, (u16)(p->unk_A0 - 3));
        }
    ...
    flags = 0x410;
    sy = y;
    DrawSprite(p->unk_4C >> 8, sy, p->unk_48->unk_10, p->tiles, p->palette, aff, flags, p->unk_A0);
    j = p->unk_A5;
    ...
    if (p->unk_A7 != 0) {
        DrawSprite((p->unk_4C >> 8) - 3, sy - 4, gUnk_09EE981C[j], gUnk_02039DD4->tiles7, gUnk_02039DD4->palette2, aff, flags, (u16)(p->unk_A0 - 10));

        if (p->unk_A6 != 0) {
            DrawSprite(p->unk_4C >> 8, sy, gUnk_02039DD4->gfx2, gUnk_02039DD4->unk_050, gUnk_02039DD4->palette, aff, flags, (u16)(p->unk_A0 - 11));
        }
    } else if (p->unk_A6 != 0) {
        DrawSprite((p->unk_4C >> 8) - 3, sy - 4, gUnk_09EE981C[j], gUnk_02039DD4->tiles6, gUnk_02039DD4->palette2, aff, flags, (u16)(p->unk_A0 - 10));
        DrawSprite(p->unk_4C >> 8, sy, gUnk_02039DD4->gfx2, gUnk_02039DD4->unk_050, gUnk_02039DD4->palette, aff, flags, (u16)(p->unk_A0 - 11));
    } else {
        DrawSprite((p->unk_4C >> 8) - 3, sy - 4, gUnk_09EE981C[j], gUnk_02039DD4->tiles5, gUnk_02039DD4->palette, aff, flags, (u16)(p->unk_A0 - 10));
    }
}
...
void func_08083714(UnkStruct_08083B20* w) {
    ...
    SetObjTileSource(w->unk_00, gUnk_0909A4E0);
    ...
    SetObjTileSource(w->unk_08, gUnk_090A0C86);
    w->unk_0C = AllocObjTiles(128, 0);
    SetObjTileSource(w->unk_0C, gUnk_090A0C86);
...
u8 func_08086A14(UnkStruct_080889DC* w, void* a) {
    ...
    if (w->unk_8C9 != 0) {
        ApproachValueHalf(&w->unk_848, gUnk_09035950[w->unk_884] << 8);
        ApproachValueHalf(&w->unk_84C, gUnk_09035956[w->unk_886] << 8);
        if (w->unk_8B7 != 0) {
            w->unk_8B7--;
        }
        TaskPoolUpdate(&w->taskpool);
...
u8 func_080870FC(UnkStruct_0808DB04* w, void* a) {
    *(void**)&w->unk_4E8[8] = AnimUpdate(&w->anim2);
    if (w->unk_8C8[1] != 0) {
        ApproachValueHalf(&w->unk_848, gUnk_090356F8[w->unk_884] << 8);
        ApproachValueHalf(&w->unk_84C, 0x1E00);
...
u8 func_08087438(UnkStruct_0808DB04* w, void* a) {
    ...
    *(void**)&w->unk_4E8[12] = AnimUpdate(&w->anim3);
    ...
    if (GetKeysPressed() & 1) {
        ...
        ApproachValueHalf(&w->unk_848, table.unk_00[w->unk_8D1[0]] << 8);
        ApproachValueHalf(&w->unk_84C, 0x7200);
        TaskPoolUpdate(&w->unk_7C8);
        TaskPoolUpdate(&w->unk_7DC);
        return 1;
    }
...
u8 func_0808778C(UnkStruct_080889DC* w, void* a) {
    ...
    ApproachValueHalf(&w->unk_848, gUnk_0903571A[w->unk_884] << 8);
    ApproachValueHalf(&w->unk_84C, (gUnk_0903571E[w->unk_886] - 16) << 8);
...
u8 func_08087CD4(UnkStruct_080889DC* w, void* a) {
    ...
    ApproachValueHalf(&w->unk_848, gUnk_0903571A[w->unk_884] << 8);
    ApproachValueHalf(&w->unk_84C, gUnk_0903571E[w->unk_886] << 8);
    TaskPoolUpdate(&w->taskpool);
    TaskPoolUpdate(&w->cardpool);
    return 1;
}
...
#endif
    if (w->unk_8C9 != 0) {
        ApproachValueHalf(&w->unk_848, gUnk_090356EC[w->unk_884] << 8);
        ApproachValueHalf(&w->unk_84C, gUnk_090356F2[w->unk_886] << 8);
        TaskPoolUpdate(&w->taskpool);
        TaskPoolUpdate(&w->cardpool);
        if (GetKeysPressed() & 8) {
            w->unk_8D2 = 7;
...
u8 func_08088F24(UnkStruct_0808DB04* w, void* a) {
    ...
    *(void**)&w->unk_4E8[12] = AnimUpdate(&w->anim3);
    ...
    switch (gLanguage) {
    case 0:
        ApproachValueHalf(&w->unk_848, 0x6600);
        break;
    case 1:
        ApproachValueHalf(&w->unk_848, 0x6200);
        break;
    case 2:
        ApproachValueHalf(&w->unk_848, 0x5E00);
        break;
    case 3:
        ApproachValueHalf(&w->unk_848, 0x6200);
        break;
    ...
    ApproachValueHalf(&w->unk_848, 0x6600);
#endif
    ApproachValueHalf(&w->unk_84C, gUnk_0903570E[w->unk_8C8[0]] << 8);
    TaskPoolUpdate(&w->unk_7C8);
    TaskPoolUpdate(&w->unk_7DC);
    return 1;
}
...
u8 func_080897CC(UnkStruct_080889DC* w, void* a) {
        ...
        case 1:
            if ((u8)func_0808E890((u8*)w) != 0) {
                ...
                if ((u8)func_0808DED0((u8*)w) != 0) {
                    ...
                    w->unk_8B1 = 5;
                    w->unk_848 = gUnk_0903571A[w->unk_884] << 8;
                    w->unk_84C = gUnk_0903571E[w->unk_886] << 8;
    ...
    ApproachValueHalf(&w->unk_848, gUnk_0903595E[w->unk_884] << 8);
    ApproachValueHalf(&w->unk_84C, gUnk_09035964[w->unk_886] << 8);
    TaskPoolUpdate(&w->taskpool);
    TaskPoolUpdate(&w->cardpool);
    return 1;
}
    ...
    case 1:
        if ((u8)func_0808E890((u8*)w) != 0) {
            ...
            if ((u8)func_0808DED0((u8*)w, 0) != 0) {
                ...
                w->unk_8B1 = 11;
                w->unk_848 = gUnk_0903571A[w->unk_884] << 8;
                w->unk_84C = (gUnk_0903571E[w->unk_886] - 16) << 8;
...
void func_0808DB50(UnkStruct_0808DB04* w) {
    ...
    if (id != 0xFFFF) {
        if (id & 0x8000) {
            ...
            SetObjTileSource(w->unk_028, gUnk_0908B1B4);
...
u8 func_0808EC24(UnkStruct_0808DB04* w) {
    ...
    if (p->unk_20 != 0xFFFF) {
        ...
        if (q != 0) {
            while (p != q) {
                n = (DeckCard2Work*)ListPoolPrev(&q->unk_2C);

                if (n != 0) {
                    *(u16*)q->unk_28 = *(u16*)n->unk_28;
                }

                q = (DeckCard2Work*)ListPoolPrev(&q->unk_2C);
            }
...
u8 func_0808EDA4(UnkStruct_0808DB04* w) {
    ...
    *b = u;
    ...
    if (ListPoolPrev(&p->unk_2C) == (MapcardWork*)q) {
        ListPoolRemove(&p->unk_2C, &w->unk_7F0);
        ListPoolInsertBefore(&p->unk_2C, &w->unk_7F0, &q->unk_2C);
        ...
        ListPoolRemove(&p->unk_2C, &w->unk_7F0);
        ListPoolInsertAfter(&p->unk_2C, &w->unk_7F0, &q->unk_2C);
        ...
        prev = (DeckCard2Work*)ListPoolRemove(&p->unk_2C, &w->unk_7F0);
        ListPoolInsertBefore(&p->unk_2C, &w->unk_7F0, &q->unk_2C);
        ListPoolRemove(&q->unk_2C, &w->unk_7F0);

        if (prev == 0) {
            ListPoolAppend(&q->unk_2C, &w->unk_7F0);
        } else {
            ListPoolInsertBefore(&q->unk_2C, &w->unk_7F0, &prev->unk_2C);
        }
    }
...
u8 func_0808F3E8(UnkStruct_0808F0C0* w, void* a) {
    ...
    case 0:
        ...
        w->unk_73C = AllocSpriteFrameTiles(0x80);
#ifdef VERSION_EU
        SetObjTileSource(w->unk_738, gUnkEu_09F6FE30[gLanguage]);
        AnimInit(&w->unk_798, gUnkEu_09F6FE58[gLanguage], gUnkEu_09F6FE44[gLanguage]);
#else
        SetObjTileSource(w->unk_738, gUnk_090A5F1E);
        AnimInit(&w->unk_798, gUnk_09EEB0B8, gUnk_09EEB08C);
#endif
        AnimStart(&w->unk_798, 0, 1);
        w->unk_7B0 = AnimGetGfx(&w->unk_798);
#ifdef VERSION_EU
        UpdateSpriteFrameTiles(w->unk_73C, gUnkEu_09F6FE44[gLanguage][10], gUnkEu_09F6FE30[gLanguage]);
#else
...
u8 func_jp_0808F638(UnkStruct_0808F0C0* w, void* a) {
    ...
    *(void**)&w->unk_1E8[0x308] = AnimUpdate(&w->unk_800);
    TaskPoolUpdate(&w->taskpool);
    TaskPoolUpdate(&w->cardpool);
    return 1;
}
...
void card_enemy_0(CardDisplayWork* p, CardDisplayArgs* a) {
    ...
    *(CardDisplayArgs*)&p->unk_38 = *a;
    ...
    p->unk_A0 = 0x50;
    p->unk_9C = 0;
    func_080901E0((s32*)&p->unk_38, (u8*)&p->unk_48, ((CardDisplayArgs*)&p->unk_38)->unk_0C);
    p->unk_54 = 0x100;
    p->unk_58 = 0x100;
    p->unk_5F = GetRandom();
    p->unk_5E = 0;
    ...
    *(u32*)&args.unk_08 = arg;
    ...
    if ((gBtlWork->unk_068 & 0x80) == 0) {
        ...
        if ((s16)gUnk_02039DD4->unk_0C2 <= p->unk_A5) {
            ...
            if (gBtlWork->unk_0F4 == 2) {
#ifdef VERSION_EU
                if (gUnk_02039DD4->unk_000[0]->unk_48->unk_2A == 0 && gUnk_02039DD4->unk_0E1 == 0) {
                    found = 1;
                }
#else
                for (i = 0; i < gUnk_02039DD4->unk_0D0; i++) {
...
#ifdef VERSION_EU
                for (k = 0; k < gUnk_02039DD4->unk_0D0; k++) {
                    if (gUnk_02039DD4->unk_000[k]->unk_48->unk_2A == 2 && !(gUnk_02039DD4->unk_000[k]->unk_48->unk_1E & 8)) {
                        found = 1;
                    }
                }
#else
        ...
        if ((s16)gUnk_02039DD4->unk_0C2 <= p->unk_A5) {
            ...
            if (gBtlWork->unk_0F4 == 29) {
                for (i = 0; i < gUnk_02039DD4->unk_0D0; i++) {
#ifdef VERSION_EU
                    if (gUnk_02039DD4->unk_000[i]->unk_48->unk_2A == 2 && !(gUnk_02039DD4->unk_000[i]->unk_48->unk_1E & 8)) {
#else
                    if (gUnk_02039DD4->unk_000[i]->unk_48->unk_2A == 2) {
#endif
                        flag = 1;
...
void MapSelect_0(MapSelectWork* w, u8* a) {
    ...
    *(u16*)w->unk_27E = n;
    ...
    if (w->unk_2BE == 0) {
        if (*(u16*)w->unk_27E == 0) {
            w->unk_02C = AllocSpriteFrameTiles(0x80);
            UpdateSpriteFrameTiles(w->unk_02C, gUnk_09EF1198[0], gUnk_0950C478);
        } else {
            w->unk_02C = AllocSpriteFrameTiles(0x180);
            UpdateSpriteFrameTiles(w->unk_02C, gUnk_09EF1198[1], gUnk_0950C478);
            RequestDma3Copy((u8*)w->unk_02C->unk_00 + (*(u16*)w->unk_27E << 7),
                           (void*)(0x06010000 + ((w->unk_02C->unk_06 + 4) << 5)), 0x80);
            RequestDma3Copy((u8*)w->unk_02C->unk_00 + 0x500,
    ...
    *(s32*)w->unk_268 = 0x6400;
    ...
    w->unk_28B = 0;
    if (w->card != 0) {
        w->unk_250 = w->card->unk_4C;
        w->unk_254 = w->card->unk_50;
        w->card->unk_6C |= 0x100;
    } else {
        w->unk_250 = -0x6400;
        w->unk_254 = -0x6400;
...
u8 MapSelect_1(MapSelectWork* w, void* a) {
    ...
    switch (gLanguage) {
    case 0:
        w->unk_038 = LoadObjTiles(gUnk_093F7172, 0x400);
        break;
    case 1:
        w->unk_038 = LoadObjTiles(gUnkEu_094C6C22, 0x400);
        RequestDma3Copy(gUnkEu_0952DDE4, (u8*)GetBgCharBase(1) + 0x1AA0, 0x100);
        break;
    case 2:
        w->unk_038 = LoadObjTiles(gUnkEu_094C789A, 0x400);
        RequestDma3Copy(gUnkEu_0952E0E4, (u8*)GetBgCharBase(1) + 0x1AA0, 0x100);
        break;
    case 3:
        w->unk_038 = LoadObjTiles(gUnkEu_094C7472, 0x400);
        RequestDma3Copy(gUnkEu_0952DFE4, (u8*)GetBgCharBase(1) + 0x1AA0, 0x100);
        break;
    case 4:
        w->unk_038 = LoadObjTiles(gUnkEu_094C704A, 0x400);
                    ...
                    if (gUnk_0203A8C0[w->card->unk_20 + 1] != 0) {
                        ...
                        if ((u8)func_080E8E24((u32)&gUnk_09EE4C80[w->card->unk_20] + 0x48) == 1) {
                            ...
                            if (w->unk_2DA == 0) {
                                w->card->unk_74 = 1;
                                w->card->unk_6C |= 0x40;
                                for (p = ListPoolFirst(&w->cards); p != 0; p = ListPoolNext(&p->unk_38)) {
                                    if (w->card != p) {
                                        p->unk_6C &= 0xFFFD;
                                    }
                                }
    ...
    if (w->unk_298 == 0) {
        if (w->card != *(MapcardWork**)w->unk_1F0) {
            ...
            *(MapcardWork**)w->unk_1F0 = w->card;
            ...
            ApproachValue(&w->unk_250, w->card->unk_4C, w->unk_28B);
            ApproachValue(&w->unk_254, w->card->unk_50, w->unk_28B);
            if (w->unk_28B != 0) {
                w->unk_28B--;
            }
        }
...
void MapSelect_2(MapSelectWork* w) {
    if (w->unk_038 != 0 && *(void**)&w->unk_040[8] != 0) {
        DrawSprite((s16)(w->unk_248 >> 8), (s16)(*(s32*)w->unk_24C >> 8),
                   ...
                   gUnk_09EF1228[0],
#endif
                   w->unk_038, *(void**)&w->unk_040[8], 0, 0, 80);
    }
    if (w->unk_2BE == 1) {
        switch (gUnk_09EE4C80[w->card->unk_20].unk_1E) {
        case 0:
            break;
        case 2:
            DrawSprite((s16)((w->card->unk_4C >> 8) + 4), (s16)((w->card->unk_50 >> 8) - 32), gUnk_0203A890.sprites[3], gUnk_0203A890.extraTiles, gUnk_0203A890.palette, 0, 0, 20);
            break;
        case 3:
            DrawSprite((s16)((w->card->unk_4C >> 8) + 4), (s16)((w->card->unk_50 >> 8) - 32), gUnk_0203A890.sprites[7], gUnk_0203A890.extraTiles, gUnk_0203A890.palette, 0, 0, 20);
            break;
        case 1:
            DrawSprite((s16)((w->card->unk_4C >> 8) + 4), (s16)((w->card->unk_50 >> 8) - 32), gUnk_0203A890.sprites[5], gUnk_0203A890.extraTiles, gUnk_0203A890.palette, 0, 0, 20);
            break;
        case 4:
            break;
        }
...
void func_08093434(MapSelectWork* work) {
    ...
    case 16:
        p = (MapcardWork*)ListPoolNext(&work->card->unk_38);

        if (p != 0 && (p->unk_6C & 1)) {
            work->unk_264 = p->unk_4C;
            work->unk_28C = 4;
            work->card->unk_6C &= 0xFEFF;
            work->card = (MapcardWork*)ListPoolNext(&work->card->unk_38);
            work->card->unk_6C |= 0x100;
            m4aSongNumStart(121);
        }
        break;
    case 32:
        p = ListPoolPrev(&work->card->unk_38);

        if (p != 0 && (p->unk_6C & 1)) {
            work->unk_264 = p->unk_4C;
            work->unk_28C = 4;
            work->card->unk_6C &= 0xFEFF;
            work->card = ListPoolPrev(&work->card->unk_38);
            work->card->unk_6C |= 0x100;
            m4aSongNumStart(121);
        }
        break;
...
s32 func_08093838(MapSelectWork* w) {
    ...
    if (q != 0) {
        ...
        *(u16*)q = r;
        ...
        return (((MapcardWork*)w->card)->unk_4C - w->unk_258) >> 8;
    }
...
void func_08093F5C(MapSelectWork* w) {
    ...
    ApproachValue(&w->unk_258, gUnk_09EE4BB8[(s8)w->unk_29C] << 8, w->unk_28C);
    ApproachValue(&w->unk_25C, gUnk_09EE4BC2[(s8)w->unk_29D] << 8, w->unk_28C);
    ApproachValue(&w->unk_250, gUnk_09EE4BB8[(s8)w->unk_29C] << 8, w->unk_28B);
    ApproachValue(&w->unk_254, (gUnk_09EE4BC2[(s8)w->unk_29D] + 34) << 8,
                  w->unk_28B);
...
void func_08094548(MapSelectWork* w) {
    ...
    n = ListPoolRemove(&w->card->unk_38, &w->cards);
    w->card->unk_6C |= 0x400;
    w->card = n;
    ...
    for (n = (MapcardWork*)ListPoolFirst(&w->cards); n != 0; n = (MapcardWork*)ListPoolNext(&n->unk_38)) {
        n->unk_6C |= 2;
    }
    ...
    if (func_08094CB0((s32*)w)) {
        if (!(w->unk_6C & 1)) {
            ...
            *(void**)&w->unk_10[4] = LoadObjPalette(b->unk_04, 32);
            ...
            FadeSetPaletteExcluded(((UnkStruct_080038C8*)w->unk_0C)->unk_06 + 16, 1);
...
void func_08094E90(MapcardWork* w) {
    ...
    ListPoolAppend(&w->unk_38, w->unk_28);
}
    ...
    if ((w->unk_78 & 0x44) == 0x44) {
        if (v == 1) {
            if ((s8)p->unk_65 == 2) {
                ...
                while (node != 0) {
                    node->unk_1C &= 0xFFFD;
                    node = (ReloadChildWork*)ListPoolNext(&node->unk_30);
                }
                ...
                if (w->unk_9F == 0) {
                    ...
                    if (w->unk_A0 == 10) {
                        ...
                        while (child != 0) {
                            child->unk_1C |= 1;
                            child->unk_18--;
                            child = (ReloadChildWork*)ListPoolNext(&child->unk_30);
                        }
...
void SELMAP_EVKEY_0(SelmapEventKeyWork* work, void* a) {
    ...
    SetObjTileSource(work->unk_00, gUnkEu_09F72A64[gLanguage]);
    AnimInit(&work->unk_DC, gUnkEu_09F72A3C[gLanguage], gUnkEu_09F72A50[gLanguage]);
#else
#ifdef VERSION_JP
    work->unk_00 = AllocObjTiles(0x480, 0);
    SetObjTileSource(work->unk_00, &gUnk_093F47E4[0x22DC]);
#else
    work->unk_00 = AllocObjTiles(0x6C0, 0);
    SetObjTileSource(work->unk_00, &gUnk_093F47E4[0x22E8]);
#endif
...
void func_0809BB4C(UnkStruct_0809BB4C* w) {
    ...
    SetObjTileSource(w->unk_08, gUnk_093F4578);
    ...
    SetObjTileSource(w->unk_10, gUnk_093F47E4);
    ...
    FadeSetPaletteExcluded((u16)(w->unk_04->unk_06 + 16), 1);
    FadeSetPaletteExcluded((u16)(w->unk_14->unk_06 + 16), 1);
    FadeSetPaletteExcluded((u16)(w->unk_0C->unk_06 + 16), 1);
    FadeSetPaletteExcluded((u16)(w->unk_1C->unk_06 + 16), 1);
...
void func_0809C534(UnkStruct_0809C534* w, UnkStruct_0809C534_Args* a) {
    ...
    ListNodeInit(&w->unk_58, &gUnk_0203A9D0->cards, w);
    ListPoolAppend(&w->unk_58, &gUnk_0203A9D0->cards);
    w->unk_55 = 0;
    w->unk_6C = 0x100;
    w->unk_6E = 0x100;
    w->unk_70 = 0;
...
void func_0809D0CC(PremiumCardEffectWork* w) {
    DrawSprite(w->unk_30 >> 8, w->unk_34 >> 8, w->gfx, w->tiles, w->palette, 0, 0, 0);
}
...
void HCEffectName_2(HcEffectNameWork* w) {
    ...
    if (w->unk_27 == 1) {
        pri = 0x410;
        DrawSprite(w->unk_00, 0x90, 0, w->tiles2, w->palette, 0, pri, 10);
        ...
        DrawSprite(w->unk_00 + 24, 0x8A, 0, w->tiles3, w->palette, 0, pri, 10);
        DrawSprite(w->unk_00 + 32, 0x8A, gUnk_09EE1538[14], w->tiles, w->palette, 0, pri, 10);
    }
#else
    if (w->unk_27 == 1) {
        DrawSprite(w->unk_00, 0x90, 0, w->tiles2, w->palette, 0, 0x400, 10);
        ...
        DrawSprite(w->unk_00 + 24, 0x8A, 0, w->tiles3, w->palette, 0, 0x400, 10);
...
void Level_Up_0(LevelUpWork* w) {
    ...
    w->unk_020[0] = AllocSpriteFrameTiles(0x500);
    w->unk_020[1] = AllocSpriteFrameTiles(0x500);
    w->unk_020[2] = AllocSpriteFrameTiles(0x500);
#endif
    ...
    if (!(gGameState.flags & 8)) {
        ...
        UpdateAllocatedObjPalette(w->unk_72C, gUnk_08F683A4);
        FadeSetPaletteExcluded(((ObjPalette*)w->unk_72C)->unk_06 + 16, 1);
        WorldToScreen(&x, &y, gBtlWork->unk_07C->unk_004,
                      gBtlWork->unk_07C->unk_008,
                      gBtlWork->unk_07C->unk_00C);
        SetObjTileSource(w->unk_728, gUnk_088E33C2);
        AnimInit(&w->unk_734, gUnk_09EDEE14, gUnk_09EDEE08);
        AnimStart(&w->unk_734, 0, 1);
    } else {
        w->unk_728 = AllocObjTiles(0x800, 0);
        w->unk_72C = AllocObjPalette(32);
        UpdateAllocatedObjPalette(w->unk_72C, gUnk_09618118);
        FadeSetPaletteExcluded(((ObjPalette*)w->unk_72C)->unk_06 + 16, 1);
        WorldToScreen(&x, &y, gBtlWork->unk_07C->unk_004,
                      gBtlWork->unk_07C->unk_008,
                      gBtlWork->unk_07C->unk_00C);
        SetObjTileSource(w->unk_728, gUnk_0891ED26);
...
u8 Level_Up_1(LevelUpWork* w, void* a) {
    ...
    if (w->unk_7C2[0] == 0) {
        ...
        if (w->unk_7A4 > 7) {
            ...
            FadeSetPaletteExcluded(((ObjPalette*)w->unk_6F8)->unk_06 + 16, 1);
            w->unk_6E8 = AllocObjTiles(0x3C0, 0);
            w->unk_6EC = LoadObjPalette(gUnk_09618CD8, 32);
            FadeSetPaletteExcluded(((ObjPalette*)w->unk_6EC)->unk_06 + 16, 1);
            SetObjTileSource(w->unk_6E8, gUnk_093F4578);
        ...
        if (w->unk_7B5 <= 11) {
            ...
            if (w->unk_7B1 <= 6) {
                ...
                if (w->unk_7B2[2] == 0) {
                    ...
                    FadeSetPaletteExcluded(((ObjPalette*)w->unk_6E0)->unk_06 + 16, 1);
                    FadeSetPaletteExcluded(((ObjPalette*)w->unk_6E4)->unk_06 + 16, 1);
                    for (i = 0; i < 3; i++) {
                        if (w->unk_7C8[i] == 1) {
                            break;
                        }
...
u8 func_0809F390(LevelUpWork* w, void* a) {
    ...
    while (GetKeysRepeat() & 1) {
        ...
        w->unk_7B2[2] = 16;
        m4aSongNumStart(102);
        ReleaseObjTiles(w->unk_6E8);
        ReleaseObjPalette(w->unk_6EC);
        w->unk_6E8 = AllocObjTiles(128, 0);
        w->unk_6EC = LoadObjPalette(&gUnk_09611AB8[palOffset], 32);
        FadeSetPaletteExcluded(((ObjPalette*)w->unk_6EC)->unk_06 + 16, 1);
        SetObjTileSource(w->unk_6E8, &gUnk_0908C686[0x2B0A]);
        AnimInit(&w->unk_710, &gUnk_09EEA1EC[0x25], &gUnk_09EEA19C[0x34]);
        AnimStart(&w->unk_710, 0, 1);
        w->unk_74C = AnimGetGfx(&w->unk_710);
        w->unk_7B6 = 16;
        w->unk_774 = 136;

        if (!(gGameState.flags & 8)) {
            SetObjTileSource(w->unk_728, gUnk_088B6560);
            AnimInit(&w->unk_734, gUnk_09EDE918, gUnk_09EDE8CC);
            AnimStart(&w->unk_734, 1, 0);
        } else {
            SetObjTileSource(w->unk_728, gUnk_092EB78A);
            AnimInit(&w->unk_734, gUnk_09EEF8C0, gUnk_09EEF89C);
            AnimStart(&w->unk_734, 1, 0);
        }
...
u8 func_0809FBCC(u8* work, void* a) {
    ...
    q1 = &work[offsetof(LevelUpWork, unk_750)];
    v1 = *(s16*)(q1 + ofs) << 8;
    ofs = (s8)work[offsetof(LevelUpWork, unk_7B0)] * 2;
    q2 = &work[offsetof(LevelUpWork, unk_75C)];
    v2 = *(s16*)(q2 + ofs) << 8;
    v3 = *(s16*)&work[offsetof(LevelUpWork, unk_77A)] << 8;
    v4 = *(s16*)&work[offsetof(LevelUpWork, unk_77C)] << 8;
    v0 = *(s16*)&work[offsetof(LevelUpWork, unk_778)] << 8;
    ...
    *(s16*)(q1 + ofs) = v1 >> 8;
    ofs = (s8)work[offsetof(LevelUpWork, unk_7B0)] * 2;
    *(s16*)(q2 + ofs) = v2 >> 8;
    *(s16*)&work[offsetof(LevelUpWork, unk_778)] = v0 >> 8;
    ...
    ApproachValue(&work[offsetof(LevelUpWork, unk_7A8)], 0x1BE00, (s8)work[offsetof(LevelUpWork, unk_7B5)]);
    ApproachValue(&work[offsetof(LevelUpWork, unk_7AC)], 0x4800, (s8)work[offsetof(LevelUpWork, unk_7B5)]);
    ...
    *(void**)&work[offsetof(LevelUpWork, unk_730)] = AnimUpdate(&work[offsetof(LevelUpWork, unk_734)]);
...
void Level_Up_3(u8* work) {
    ...
    if (*(void**)&work[offsetof(LevelUpWork, unk_6E0)] != 0) {
        ReleaseObjPalette(*(void**)&work[offsetof(LevelUpWork, unk_6E0)]);
    }

    if (*(void**)&work[offsetof(LevelUpWork, unk_6E4)] != 0) {
        ReleaseObjPalette(*(void**)&work[offsetof(LevelUpWork, unk_6E4)]);
    }

    if (*(void**)&work[offsetof(LevelUpWork, unk_6E8)] != 0) {
        ReleaseObjTiles(*(void**)&work[offsetof(LevelUpWork, unk_6E8)]);
    }

    if (*(void**)&work[offsetof(LevelUpWork, unk_6EC)] != 0) {
        ReleaseObjPalette(*(void**)&work[offsetof(LevelUpWork, unk_6EC)]);
    }

    if (*(void**)&work[offsetof(LevelUpWork, unk_6F0)] != 0) {
        ReleaseObjTiles(*(void**)&work[offsetof(LevelUpWork, unk_6F0)]);
    }

    if (*(void**)&work[offsetof(LevelUpWork, unk_6F4)] != 0) {
        ReleaseObjTiles(*(void**)&work[offsetof(LevelUpWork, unk_6F4)]);
    }

    if (*(void**)&work[offsetof(LevelUpWork, unk_6F8)] != 0) {
        ReleaseObjPalette(*(void**)&work[offsetof(LevelUpWork, unk_6F8)]);
    }

    if (*(void**)&work[offsetof(LevelUpWork, unk_728)] != 0) {
        ReleaseObjTiles(*(void**)&work[offsetof(LevelUpWork, unk_728)]);
    }

    if (*(void**)&work[offsetof(LevelUpWork, unk_72C)] != 0) {
        ReleaseObjPalette(*(void**)&work[offsetof(LevelUpWork, unk_72C)]);
    }
...
u8 func_080A0A44(LevelUpWork* w, void* a) {
    ...
    w->unk_730 = AnimUpdate(&w->unk_734);
    {
        s32 x0 = w->unk_750[0] << 8;
        s32 x1 = w->unk_750[1] << 8;
        s32 x2 = w->unk_750[2] << 8;
...
u8 func_080A11CC(LevelUpWork* w, void* a) {
    ...
    x = w->unk_750[w->unk_7B0] << 8;
    y = w->unk_75C[w->unk_7B0] << 8;
    ApproachValue(&x, -0x8000, w->unk_7B2[w->unk_7B0]);
    ApproachValue(&y, -0xF800, w->unk_7B2[w->unk_7B0]);
    w->unk_750[w->unk_7B0] = x >> 8;
    w->unk_75C[w->unk_7B0] = y >> 8;
    w->unk_7B2[w->unk_7B0]--;
    ...
    if (n == 0) {
        if (w->unk_7BF != 0) {
            ...
            if (w->unk_020[0] != 0) {
                ReleaseObjTiles(w->unk_020[0]);
            }

            if (w->unk_020[1] != 0) {
                ReleaseObjTiles(w->unk_020[1]);
            }

            if (w->unk_020[2] != 0) {
                ReleaseObjTiles(w->unk_020[2]);
            }
#endif
            ...
            if (w->unk_6E0 != 0) {
                ReleaseObjPalette(w->unk_6E0);
            }

            if (w->unk_6E4 != 0) {
                ReleaseObjPalette(w->unk_6E4);
            }
            ...
            if (w->unk_6F4 != 0) {
                ReleaseObjTiles(w->unk_6F4);
            }

            if (w->unk_6F8 != 0) {
                ReleaseObjPalette(w->unk_6F8);
            }
...
void func_080A2E14(DeckConfirmWork* w) {
    DrawTextSlots(w->unk_792, w->unk_796, w, w->palette, 1, w->unk_78C);
    DrawTextSlots(w->unk_794, w->unk_798, w->unk_280, w->palette, 1, w->unk_78D);
    DrawTextSlots(w->unk_79A, w->unk_79C, w->unk_500, w->palette, 1, w->unk_78E);
...
u8 func_080A3640(UnkStruct_080A3F5C* w, void* a) {
    ...
    SetBgMapBlocks(w->unk_10C, gUnk_09EE4724[((NumberPlusArgs*)w->unk_114)->unk_04], 2, 1);
...
u8 func_080A3754(UnkStruct_080A3F5C* w, void* a) {
    ...
    if (sel->unk_00 != 62) {
        ...
        SetObjTileSource(w->tiles3, e[w->unk_114->unk_08].unk_00);
...
void func_080A4A50(UnkStruct_080A3F5C* w) {
    ...
    if (w->tiles3 != 0) {
        if (w->unk_141 != 0) {
            DrawSprite(120, gUnk_09033D08[w->unk_114->unk_04][1] >> 8, *(void**)&w->gfx4,
...
void func_080A52BC(UnkStruct_080A3F5C* w) {
    ...
    if (w->tiles3 != 0 && w->unk_141 != 0) {
        DrawSprite(120, gUnk_09033D08[w->unk_114->unk_04][1] >> 8, w->gfx4, w->tiles3, w->palette, 0, 0, 10);
    }

    if (w->tiles4 != 0) {
        DrawSprite(w->unk_118 >> 8, w->unk_11C >> 8, w->gfx, w->tiles4, w->palette2, 0, 1, 10);
    }
...
void WorldSel_Before_0(WorldSelBeforeWork* w, WorldSelBeforeArgs* a) {
    ...
    *(WorldSelBeforeArgs*)&w->unk_10 = *a;
    ...
    w->unk_1D = 0;
    w->unk_A3 = 0;
    UpdateAllocatedObjPalette(w->unk_0C, &gUnk_09619178[gUnk_09EE8E60[w->unk_1C].unk_00 << 5]);
    FadeSetPaletteExcluded(((UnkStruct_080038C8*)w->palette)->unk_06 + 16, 1);
    FadeSetPaletteExcluded(w->unk_0C->unk_06 + 16, 1);
...
void func_080A6FAC(UnkStruct_080A6FAC* w) {
    ...
    if (id != 0xFFFF) {
        if (id & 0x8000) {
            ...
            SetObjTileSource(w->unk_024, gUnk_0908B1B4);
            AnimInit(&w->anim, gUnk_09EEA164, gUnk_09EEA148);
            AnimStart(&w->anim, 0, 1);
            w->gfx = AnimGetGfx(&w->anim);
        }
...
u8 func_080A8430(UnkStruct_0808C940* w, void* a) {
    ...
    case 5:
        ...
        func_080A9AE8((u8*)w);
        w->unk_694 = gUnk_0903595E[0] << 8;
        w->unk_698 = gUnk_09035964[0] << 8;
        w->unk_706 = 2;
        w->unk_6D0 = 0;
        w->unk_6D2 = 0;
        func_080AA450((u8*)w);
...
u8 func_080A86F4(UnkStruct_0808C940* w, void* a) {
    ...
    case 1:
        if ((u8)func_080AAD2C(w) != 0) {
            ...
            if ((u8)func_080AA77C(w, 0) != 0) {
                func_080AA680((u8*)w);
                w->unk_694 = gUnk_09041F30[w->unk_6D0] << 8;
                w->unk_698 = (gUnk_09041F34[w->unk_6D2] - 16) << 8;
    ...
    if (w->unk_6F6 != 0) {
        ApproachValue(&w->unk_694, gUnk_0903595E[w->unk_6D0] << 8, w->unk_6F6);
        ApproachValue(&w->unk_698, gUnk_09035964[w->unk_6D2] << 8, w->unk_6F6);
        w->unk_6F6--;
    }
    TaskPoolUpdate(&w->unk_614);
    TaskPoolUpdate(&w->unk_628);
...
void mode_sio_battle_1(void) {
    ...
    DrawSprite(((UnkStruct_02034B38*)gUnk_02034B38)->unk_08 >> 8, 0, ((UnkStruct_02034B38*)gUnk_02034B38)->unk_1C[0], ((UnkStruct_02034B38*)gUnk_02034B38)->tiles, ((UnkStruct_02034B38*)gUnk_02034B38)->palette, 0, 0x400, -16);
    DrawSprite(128, ((UnkStruct_02034B38*)gUnk_02034B38)->unk_0C >> 8, ((UnkStruct_02034B38*)gUnk_02034B38)->unk_1C[1], ((UnkStruct_02034B38*)gUnk_02034B38)->tiles, ((UnkStruct_02034B38*)gUnk_02034B38)->palette, 0, 0x400, -1);
    DrawSprite(128, ((UnkStruct_02034B38*)gUnk_02034B38)->unk_10 >> 8, ((UnkStruct_02034B38*)gUnk_02034B38)->unk_1C[2], ((UnkStruct_02034B38*)gUnk_02034B38)->tiles, ((UnkStruct_02034B38*)gUnk_02034B38)->palette, 0, 0x400, -1);
    DrawSprite(72, 48, ((UnkStruct_02034B38*)gUnk_02034B38)->unk_30, ((UnkStruct_02034B38*)gUnk_02034B38)->tiles2, ((UnkStruct_02034B38*)gUnk_02034B38)->palette2, 0, 0x400, -32);
    DrawSprite(72, 48, ((UnkStruct_02034B38*)gUnk_02034B38)->unk_3C, ((UnkStruct_02034B38*)gUnk_02034B38)->tiles3, ((UnkStruct_02034B38*)gUnk_02034B38)->palette3, 0, 0x400, -32);
