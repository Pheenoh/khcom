...
s32 func_0809AD98(u8* work, void* a);
...
void func_0808B3DC(u8* work, u8 flag) {
    if (flag == 0) {
        switch (work[0x8C0]) {
        case 0:
            func_080664D8(*(s16*)&work[0x888], *(s16*)&work[0x88E], &work[0x38], *(void**)&work[0x14], 20, work[0x8C2]);
            func_080664D8(*(s16*)&work[0x88A], *(s16*)&work[0x890], &work[0x78], *(void**)&work[0x4C4], 20, work[0x8C3]);
            func_080664D8(*(s16*)&work[0x88C], *(s16*)&work[0x892], &work[0xB8], *(void**)&work[0x4C4], 20, work[0x8C4]);
            break;
        case 1:
            func_080664D8(*(s16*)&work[0x888], *(s16*)&work[0x88E], &work[0x38], *(void**)&work[0x4C4], 20, work[0x8C2]);
            func_080664D8(*(s16*)&work[0x88A], *(s16*)&work[0x890], &work[0x78], *(void**)&work[0x14], 20, work[0x8C3]);
            func_080664D8(*(s16*)&work[0x88C], *(s16*)&work[0x892], &work[0xB8], *(void**)&work[0x4C4], 20, work[0x8C4]);
            break;
        case 2:
            func_080664D8(*(s16*)&work[0x888], *(s16*)&work[0x88E], &work[0x38], *(void**)&work[0x4C4], 20, work[0x8C2]);
            func_080664D8(*(s16*)&work[0x88A], *(s16*)&work[0x890], &work[0x78], *(void**)&work[0x4C4], 20, work[0x8C3]);
            func_080664D8(*(s16*)&work[0x88C], *(s16*)&work[0x892], &work[0xB8], *(void**)&work[0x14], 20, work[0x8C4]);
            break;
        }
    } else {
        switch (work[0x8C0]) {
...
s32 func_08093838(u8* work) {
    ...
    node = (UnkStruct_02034AAC*)ListPoolFirst(&work[20]);
    best = 0x100;
    z = 0;
    *(void**)&work[0x1EC] = z;
    ...
    while (node != 0) {
        if (node->unk_4C != -0x6400) {
            d = (node->unk_4C >> 8) - (*(s32*)&work[0x258] >> 8);
            r = Sqrt(d * d);

            if (best > r) {
                best = r;
                *(void**)&work[0x1EC] = node;
            }
        }
    ...
    if (q != 0) {
        ...
        *(u16*)q = r;
        ...
        return (((UnkStruct_02034AAC*)*(void**)&work[0x1EC])->unk_4C -
                *(s32*)&work[0x258]) >> 8;
    }
...
#ifdef NON_MATCHING
u8 func_08097138(u8* work, void* a) {
    s16 x;
    s16 y;

    *(s32*)&work[0xB4] += 56;
    *(s32*)&work[0xA8] += *(s32*)&work[0xB4];
    *(s32*)&work[0xA0] += (gSineTable[work[0xDC]] * *(s32*)&work[0xB8]) >> 8;
    *(s32*)&work[0xA4] += (-gSineTable[work[0xDC] + 64] * *(s32*)&work[0xB8]) >> 8;

    if (func_0801A8A4(&work[0xA0], &work[0xA4], -10, -10)) {
        *(u16*)&work[0xDC] += GetRandom() % 57 + 100;
    }

    if (gBtlWork->unk_0F4 == 6) {
        ColliderSetRadius(&work[0x44], 50);
    } else {
        ColliderSetRadius(&work[0x44], 10);
    }

    if (*(s32*)&work[0xA8] - 8 > *(s32*)&work[0xAC]) {
        *(s32*)&work[0xA8] = *(s32*)&work[0xAC] - 8;
        *(s32*)&work[0xB4] = -((*(s32*)&work[0xB4] * 217) >> 8);
        *(u16*)&work[0xDC] = (u8)GetAngle(*(s32*)&work[0xA0], *(s32*)&work[0xA4], ((UnkStruct_0809E0A4*)gBtlWork->unk_07C)->unk_04, ((UnkStruct_0809E0A4*)gBtlWork->unk_07C)->unk_08);
        *(u16*)&work[0xDC] = *(u16*)&work[0xDC] - 32 + GetRandom() % 65;

        if (*(s32*)&work[0xB4] > -0x200) {
            *(s32*)&work[0xB4] = -0x200;
        }
    }
    ...
    if (work[0x70] != 0) {
        work[0xE5] = 1;
        m4aSongNumStart(106);
        func_080938F8(*(u16*)&work[0xB0]);
        SetTaskUpdate(a, (void*)func_08097404);
        WorldToScreen(&x, &y, *(s32*)&work[0xA0], *(s32*)&work[0xA4], *(s32*)&work[0xA8]);
        *(s32*)&work[0xA0] = x << 8;
        *(s32*)&work[0xA4] = y << 8;
        func_08012614(&work[0x44], 1);
        *(u16*)&work[0xCC] = 50;
        func_08097390(work);
    } else {
        func_08012324(&work[0x44], *(s32*)&work[0xA0], *(s32*)&work[0xA4], *(s32*)&work[0xA8]);
        WorldToScreen((s16*)&work[0xCE], (s16*)&work[0xD0], *(s32*)&work[0xA0], *(s32*)&work[0xA4], *(s32*)&work[0xA8]);
        WorldToScreen((s16*)&work[0xD6], (s16*)&work[0xD8], *(s32*)&work[0xA0], *(s32*)&work[0xA4], *(s32*)&work[0xAC]);
        *(u16*)&work[0xCC] = -0x1004 - (*(s32*)&work[0xA4] >> 8) * 4;
        func_080978B0((UnkStruct_080978B0*)work);
        work[0xE0] += 2;

        if (work[0xE1] == 20) {
            func_08012614(&work[0x44], 0);
        }
...
#ifndef VERSION_EU
s32 func_0809A54C(u8* work, void* a) {
    s16 sx;
    s32 t;
    u16 n;
    s16 sy;
    ...
    *(s32*)&work[0x3C] += (-gSineTable[work[0x1C6] + 64] * *(s32*)&work[0x1A8]) >> 8;
    ...
    if (func_0801A8A4(&work[0x38], &work[0x3C], -10, -10) != 0) {
        work[0x1C6] = (u8)(work[0x1C6] + 112) + GetRandom() % 33;
    }

    if (*(s32*)&work[0x40] - 0x800 > *(s32*)&work[0x44]) {
        *(s32*)&work[0x40] = *(s32*)&work[0x44] - 0x800;
        *(s32*)&work[0x1A4] = -((204 * *(s32*)&work[0x1A4]) >> 8);
        work[0x1C6] = GetAngle(*(s32*)&work[0x38], *(s32*)&work[0x3C],
                               ((UnkStruct_0809E0A4*)gBtlWork->unk_07C)->unk_04,
                               ((UnkStruct_0809E0A4*)gBtlWork->unk_07C)->unk_08);
        work[0x1C6] = (u8)(work[0x1C6] + 224) + GetRandom() % 65;

        if (*(s32*)&work[0x1A4] > -0x200) {
            *(s32*)&work[0x1A4] = -0x200;
        }
    }

    if (gBtlWork->unk_0F4 == 6) {
        ColliderSetRadius(&work[0x144], 50);
    } else {
        ColliderSetRadius(&work[0x144], 10);
    }

    if ((u8)func_0801C6D4((s32*)&work[0x38], (s32*)&work[0x3C], (s32*)&work[0x40],
                          (s32*)&work[0x44]) != 0) {
        work[0x1C6] = (u8)(work[0x1C6] + 112) + GetRandom() % 33;
    }
    ...
    if (work[0x170] != 0) {
        ...
        if (gUnk_02039DD4 != 0) {
            WorldToScreen(&sx, &sy, *(s32*)&work[0x38], *(s32*)&work[0x3C],
                          *(s32*)&work[0x40]);
            *(s32*)&work[0x38] = sx << 8;
            *(s32*)&work[0x3C] = sy << 8;
            work[0x1CA] = 1;
            func_08012614(&work[0x144], 1);
            func_0809A4E0(work, 0);
    ...
    func_08012324(&work[0x144], *(s32*)&work[0x38], *(s32*)&work[0x3C],
                  *(s32*)&work[0x40]);
    ((UnkStruct_0809A02C*)work)->unk_1B8 =
        (-gSineTable[((((UnkStruct_0809A02C*)work)->unk_1C7 + 128) & 0xFF) + 64] *
         ((UnkStruct_0809A02C*)work)->unk_1BC) >> 8;
    ((UnkStruct_0809A02C*)work)->unk_1BA =
        (-gSineTable[((((UnkStruct_0809A02C*)work)->unk_1C8 + 128) & 0xFF) + 64] *
         ((UnkStruct_0809A02C*)work)->unk_1BC) >> 8;
    ...
    ((UnkStruct_0809A02C*)work)->unk_1C7 += 2;
    ((UnkStruct_0809A02C*)work)->unk_1C2 = -0x1004 - (*(s32*)&work[0x3C] >> 8) * 4;
    TaskPoolUpdate((TaskPool*)&work[0x20]);
...
#endif
#ifndef VERSION_EU
s32 func_0809A840(u8* work, void* a) {
    s16 sx;
    s32 t;
    u16 n;
    s16 sy;
...
s32 func_0809AD98(u8* work, void* a) {
    ...
    if (*(s32*)&work[0x1A8] < 0) {
        dx = 0x7800 - *(s32*)&work[0x38];
        dy = 0x5000 - *(s32*)&work[0x3C];
        func_0805F5A4(&dx, &dy);
        *(s32*)&work[0x1B0] = -dx;
        *(s32*)&work[0x1B4] = -dy;
        ...
        if (*(s32*)&work[0x1AC] < 0x800) {
            ...
            work[0x1C9] = 0;
            work[0x1C7] = 0;
            *(s32*)&work[0x38] = 0x7800;
            *(s32*)&work[0x3C] = 0x5000;
            *(u16*)&work[0x1B8] = v = 0x100;
            *(u16*)&work[0x1BA] = v;
            func_08096F08(&work[0x20], gCardDefs[*(s32*)&work[0x1A0]].unk_0C);
    ...
    *(s32*)&work[0x3C] += (*(s32*)&work[0x1B4] * *(s32*)&work[0x1A8]) >> 8;
    ...
    ((UnkStruct_0809A02C*)work)->unk_1C8 += (64 - ((UnkStruct_0809A02C*)work)->unk_1C8) >> 4;
    ((UnkStruct_0809A02C*)work)->unk_1C7 = 0;
    *(s32*)&work[0x1AC] = func_0805F588(0x7800 - *(s32*)&work[0x38], 0x5000 - *(s32*)&work[0x3C]);
    *(s32*)&work[0x1A8] -= *(s32*)&work[0x1A4];
    *(s32*)&work[0x1A4] += 2;
    t = ((UnkStruct_0809A02C*)work)->unk_1BC;
...
#endif
#ifndef VERSION_EU
s32 func_0809AF84(u8* work, void* a) {
    s16 x;
    s16 y;
    ...
    *(s32*)&work[0x3C] += (-gSineTable[work[0x1C6] + 64] * *(s32*)&work[0x1A8]) >> 8;
    ...
    if (func_0801A8A4(&work[0x38], &work[0x3C], -10, -10) != 0) {
        work[0x1C6] = (u8)(work[0x1C6] + 0x70) + GetRandom() % 33;
    }

    if (*(s32*)&work[0x40] - 0x800 > *(s32*)&work[0x44]) {
        *(s32*)&work[0x40] = *(s32*)&work[0x44] - 0x800;
        *(s32*)&work[0x1A4] = -((*(s32*)&work[0x1A4] * 204) >> 8);
        work[0x1C6] = GetAngle(*(s32*)&work[0x38], *(s32*)&work[0x3C], ((UnkStruct_0809E0A4*)gBtlWork->unk_07C)->unk_04, ((UnkStruct_0809E0A4*)gBtlWork->unk_07C)->unk_08);
        work[0x1C6] = (u8)(work[0x1C6] + 0xE0) + GetRandom() % 65;
    ...
    if (func_0801C6D4((s32*)&work[0x38], (s32*)&work[0x3C], (s32*)&work[0x40], (s32*)&work[0x44])) {
        work[0x1C6] = (u8)(work[0x1C6] + 0x70) + GetRandom() % 33;
    }

    if (work[0x170] != 0) {
        m4aSongNumStart(0x6A);
        func_08084458(*(u16*)&work[0x1A0]);
        WorldToScreen(&x, &y, *(s32*)&work[0x38], *(s32*)&work[0x3C], *(s32*)&work[0x40]);
        *(s32*)&work[0x38] = x << 8;
        *(s32*)&work[0x3C] = y << 8;
        work[0x1CA] = 1;
        func_08012614(&work[0x144], 1);
        func_0809A4E0(work, 1);
        SetTaskUpdate(a, (void*)func_0809AD98);
        return 1;
    }

    func_08012324(&work[0x144], *(s32*)&work[0x38], *(s32*)&work[0x3C], *(s32*)&work[0x40]);
    ((UnkStruct_0809A02C*)work)->unk_1B8 = (-gSineTable[((((UnkStruct_0809A02C*)work)->unk_1C7 + 128) & 0xFF) + 64] * ((UnkStruct_0809A02C*)work)->unk_1BC) >> 8;
    ((UnkStruct_0809A02C*)work)->unk_1BA = (-gSineTable[((((UnkStruct_0809A02C*)work)->unk_1C8 + 128) & 0xFF) + 64] * ((UnkStruct_0809A02C*)work)->unk_1BC) >> 8;
    ...
    ((UnkStruct_0809A02C*)work)->unk_1C7 += 2;
    ((UnkStruct_0809A02C*)work)->unk_1C2 = -0x1004 - ((*(s32*)&work[0x3C] >> 8) << 2);
    TaskPoolUpdate((TaskPool*)&work[32]);
    return 1;
}
#else
...
void func_0809B200(u8* work) {
    ...
    if (work[0x1CD] != 0) {
        ...
        DrawSprite(x, (u16)y - 8,
                   ...
                   ((UnkStruct_0809B200*)gUnk_02039DD4)->unk_030[(*(CardDef**)&work[0x1C])->unk_2A],
                   *(void**)&work[0x04], affine,
        ...
        kind = (*(CardDef**)&work[0x1C])->unk_20;
        DrawSprite(x, (u16)y - 8, gUnk_09EE981C[kind],
                   *(void**)&work[0x10], *(void**)&work[0x04], affine,
...
u8 func_080A36B0(u8* work, void* a) {
#ifdef VERSION_JP
    work[0x143] = func_0806BDB8(gUnk_09033CA8[(*(UnkStruct_080A3F5C_Sel**)&work[0x114])->unk_04],
                                gUnk_09033CB8[(*(UnkStruct_080A3F5C_Sel**)&work[0x114])->unk_04],
                                *(s32*)((u8*)*(UnkStruct_080A3F5C_Sel**)&work[0x114] + 0x0C),
                                (s32*)&work[0x138]);
#else
    s32* p;
    ...
    if (*p != 0) {
        work[0x143] = func_0806BB44(gUnk_09033CA8[(*(UnkStruct_080A3F5C_Sel**)&work[0x114])->unk_04],
                                    gUnk_09033CB8[(*(UnkStruct_080A3F5C_Sel**)&work[0x114])->unk_04] - 0x200,
                                    *p, p);
    } else {
        work[0x143] = func_0806BB44(gUnk_09033CA8[(*(UnkStruct_080A3F5C_Sel**)&work[0x114])->unk_04],
                                    gUnk_09033CB8[(*(UnkStruct_080A3F5C_Sel**)&work[0x114])->unk_04] - 0x200,
                                    (s32)LANGSTR(*(void**)((u8*)*(UnkStruct_080A3F5C_Sel**)&work[0x114] + 0x0C)), p);
    }
#endif

    func_08065ACC((TextSlot*)&work[32], 10);
    func_08065ACC((TextSlot*)&work[112], 10);
...
void func_080A4A50(u8* work) {
    func_0806C2C0(work[0x139]);
    ...
    case 3:
        if (*(void**)&work[0x18] != 0) {
            if (work[0x147] != 0) {
                DrawSprite(*(s32*)&work[0x120] >> 8, *(s32*)&work[0x124] >> 8, (&gUnk_09EF12E8[2])[0],
                           *(void**)&work[0x18], *(void**)&work[0x1C], 0, 0, 10);
            } else {
                DrawSprite(*(s32*)&work[0x120] >> 8, *(s32*)&work[0x124] >> 8, (&gUnk_09EF1278[2])[0],
                           *(void**)&work[0x18], *(void**)&work[0x1C], 0, 0, 10);
            }
        }
        break;
    ...
    if (*(void**)&work[0x00] != 0) {
        if (work[0x141] != 0) {
            DrawSprite(120, gUnk_09033D08[(*(s32**)&work[0x114])[1]][1] >> 8, *(void**)&work[0x128],
                       *(void**)&work[0x00], *(void**)&work[0x04], 0, 0, 5);
        }
    }

    if (*(void**)&work[0x08] != 0) {
        DrawSprite(*(s32*)&work[0x118] >> 8, *(s32*)&work[0x11C] >> 8, *(void**)&work[0x12C],
                   *(void**)&work[0x08], *(void**)&work[0x0C], 0, 1, 5);
    }

    if (work[0x144] != 0) {
        DrawSprite(120, 75, gUnk_09EF126C[1], *(void**)&work[0x10], *(void**)&work[0x14], 0, 0, 10);
        func_080664D8((240 - func_08065B08((TextSlot*)&work[0x20], work[0x13F])) >> 1, 62, &work[0x20],
                      *(void**)&work[0xC0], 0, work[0x13F]);
        func_080664D8((240 - func_08065B08((TextSlot*)&work[0x70], work[0x140])) >> 1, 77, &work[0x70],
                      *(void**)&work[0xC0], 0, work[0x140]);
    }
}
...
void func_080A8C58(u8* work, u8 b) {
    if (b == 0) {
        switch (work[0x700]) {
        case 0:
            func_080664D8(*(s16*)&work[0x6D4], *(s16*)&work[0x6DA], &work[0x28], *(void**)&work[0xC], 20, work[0x702]);
            func_080664D8(*(s16*)&work[0x6D6], *(s16*)&work[0x6DC], &work[0x68], *(void**)&work[0x4BC], 20, work[0x703]);
            func_080664D8(*(s16*)&work[0x6D8], *(s16*)&work[0x6DE], &work[0xA8], *(void**)&work[0x4BC], 20, work[0x704]);
            break;
        case 1:
            func_080664D8(*(s16*)&work[0x6D4], *(s16*)&work[0x6DA], &work[0x28], *(void**)&work[0x4BC], 20, work[0x702]);
            func_080664D8(*(s16*)&work[0x6D6], *(s16*)&work[0x6DC], &work[0x68], *(void**)&work[0xC], 20, work[0x703]);
            func_080664D8(*(s16*)&work[0x6D8], *(s16*)&work[0x6DE], &work[0xA8], *(void**)&work[0x4BC], 20, work[0x704]);
            break;
        case 2:
            func_080664D8(*(s16*)&work[0x6D4], *(s16*)&work[0x6DA], &work[0x28], *(void**)&work[0x4BC], 20, work[0x702]);
            func_080664D8(*(s16*)&work[0x6D6], *(s16*)&work[0x6DC], &work[0x68], *(void**)&work[0x4BC], 20, work[0x703]);
            func_080664D8(*(s16*)&work[0x6D8], *(s16*)&work[0x6DE], &work[0xA8], *(void**)&work[0xC], 20, work[0x704]);
            break;
        }
    } else {
        switch (work[0x700]) {
...
void DarkPoint_2(u8* work) {
    DrawSprite(*(s32*)&work[0x04] >> 8, 27, gUnk_09EF1298[0], *(void**)&work[0x00], gUnk_02039DD4->palette, 0, 0, 30);

    if (work[0x0C] != 0) {
        DrawSprite((*(s32*)&work[0x04] >> 8) + 11, 30, gUnk_09EF1298[work[0x0C] + 1], *(void**)&work[0x00], gUnk_02039DD4->palette, 0, 0, 29);
        DrawSprite((*(s32*)&work[0x04] >> 8) + 17, 30, gUnk_09EF1298[work[0x0D] + 1], *(void**)&work[0x00], gUnk_02039DD4->palette, 0, 0, 29);
        DrawSprite((*(s32*)&work[0x04] >> 8) + 23, 30, gUnk_09EF1298[work[0x0E] + 1], *(void**)&work[0x00], gUnk_02039DD4->palette, 0, 0, 29);
    } else if (work[0x0D] != 0) {
        DrawSprite((*(s32*)&work[0x04] >> 8) + 15, 30, gUnk_09EF1298[work[0x0D] + 1], *(void**)&work[0x00], gUnk_02039DD4->palette, 0, 0, 29);
        DrawSprite((*(s32*)&work[0x04] >> 8) + 21, 30, gUnk_09EF1298[work[0x0E] + 1], *(void**)&work[0x00], gUnk_02039DD4->palette, 0, 0, 29);
    } else {
        DrawSprite((*(s32*)&work[0x04] >> 8) + 17, 30, gUnk_09EF1298[work[0x0E] + 1], *(void**)&work[0x00], gUnk_02039DD4->palette, 0, 0, 29);
    }
}
