...
const UnkStruct_080E8E24 gUnk_0985814C[40] = {
    { { 0, 0 }, CARD_KINGDOM_KEY_0 },
    { { 8, 0 }, CARD_OLYMPIA_0 },
    { { 1, 0 }, CARD_THREE_WISHES_0 },
    { { 2, 0 }, CARD_CRABCLAW_0 },
    { { 3, 0 }, CARD_PUMPKINHEAD_0 },
    { { 4, 0 }, CARD_FAIRY_HARP_0 },
    { { 5, 0 }, CARD_WISHING_STAR_0 },
    { { 6, 0 }, CARD_SPELLBINDER_0 },
    { { 7, 0 }, CARD_METAL_CHOCOBO_0 },
    { { 9, 0 }, CARD_LIONHEART_0 },
    { { 10, 0 }, CARD_LADY_LUCK_0 },
    { { 11, 0 }, CARD_DIVINE_ROSE_0 },
    { { 12, 0 }, CARD_OATHKEEPER_0 },
    { { 13, 0 }, CARD_OBLIVION_0 },
    { { 14, 0 }, CARD_ULTIMA_WEAPON_0 },
    { { 15, 0 }, CARD_DIAMOND_DUST_0 },
    { { 16, 0 }, CARD_ONE_WINGED_ANGEL_0 },
    { { 17, 0 }, CARD_FIRE_0 },
    { { 18, 0 }, CARD_BLIZZARD_0 },
    { { 19, 0 }, CARD_THUNDER_0 },
    { { 20, 0 }, CARD_CURE_0 },
    { { 21, 0 }, CARD_GRAVITY_0 },
    { { 22, 0 }, CARD_STOP_0 },
    ...
    { { 26, 0 }, CARD_BAMBI_0 },
    { { 27, 0 }, CARD_DUMBO_0 },
    { { 28, 0 }, CARD_TINKER_BELL_0 },
    { { 29, 0 }, CARD_MUSHU_0 },
    { { 30, 0 }, CARD_CLOUD_0 },
    { { 31, 0 }, CARD_POTION_0 },
    { { 32, 0 }, CARD_HI_POTION_0 },
    { { 33, 0 }, CARD_MEGA_POTION_0 },
    { { 34, 0 }, CARD_ETHER_0 },
    { { 35, 0 }, CARD_MEGA_ETHER_0 },
    { { 36, 0 }, CARD_ELIXIR_0 },
    { { 37, 0 }, CARD_MEGALIXIR_0 },
    { { 57, 0 }, CARD_LEXAEUS_9 },
    { { 56, 0 }, CARD_ANSEM_9 },
};
