...
void func_080DDDDC(struct UnkStruct_080DDDDC* p, struct UnkStruct_096FE034* q);
u8 func_080DDDEC(struct UnkStruct_080DDDDC* p, struct UnkStruct_096FE034* q, u8 a);
void func_080DDEA4(void);
void func_080DDEB0(s32 a);
void func_080DDEBC(s32 a);
u8* func_080DED98(u8 a);
struct UnkStruct_080DEDD8* func_080DEDD8(u8 a);
struct UnkStruct_080DEE18* func_080DEE18(u8 index);
...
void func_080DF640(u8 a, struct UnkStruct_080DF640* p);
void func_080DF6D0(struct UnkStruct_0203C7AC* p, u8 a);
...
u8 func_080DFCDC(struct UnkStruct_080DFF1C* p);
u8 func_080DFD84(struct UnkStruct_080DFF1C* p);
u8 _080DFE1C(struct UnkStruct_080DFF1C* p);
