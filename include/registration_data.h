...
extern const char gTaskNameCardNotHave[];
extern const char gTaskNameCardReload[];
extern const char gTaskName_09EE49CC[];
extern const char gTaskNameNOCard[];
extern const char gTaskNameReloadCard[];
extern const char gTaskName_09EE4AF4[];
extern const char gTaskNameDeckCard2[];
extern const char gTaskNameCardEnemy[];
extern const char gTaskNameEnemyUsecard[];
extern const char gTaskNameReloadGage[];
extern const char gTaskName_09EE75D8[];
extern const char gTaskName_09EE7650[];
extern const char gTaskNameRELOAD[];
extern const char gTaskNameFriendCard[];
extern const char gTaskNameHeartlessCard[];
extern const char gTaskNameGimmickCard[];
extern const char gTaskNameStockName[];
extern const char gTaskName_09EE7804[];
extern const char gTaskName_09EE781C[];
extern const char gTaskNameCardName[];
extern const char gTaskNamePremireEFFECT[];
extern const char gTaskNamePremireEFFECT2[];
extern const char gTaskNameStockInfo[];
extern const char gTaskNameLvupMsg[];
extern const char gTaskNameDeckEquip[];
extern const char gTaskNameDeckYesNo[];
extern const char gTaskNameDeckClear[];
extern const char gTaskNameDeckError[];
extern const char gTaskName_09EE8E18[];
extern const char gTaskNameSysmsgwin[];
extern const char gTaskName_09EE8EF0[];
extern const char gTaskNameDarkPoint[];
...
extern const char gTaskNamePooTrap[];
extern const char gTaskNamePooPitAndButterfly[];
extern const char gTaskNamePooTrapballoon[];
extern const char gTaskNamePooHoney[];
extern const char gTaskNamePooTigerstump[];
extern const char gTaskNamePooPoohstump[];
extern const char gTaskNamePooTiBoard[];
extern const char gTaskNamePooButterflyRight[];
