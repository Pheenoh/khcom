...
arm-none-eabi-cpp -nostdinc -undef -I include -I tools -I /tmp -I /tmp/claude-1000/-home-pheenoh-git-c-com/a1bfa4de-60d5-4f26-80f7-ed193de463ed/scratchpad/bos2 -I /tmp/claude-1000/-home-pheenoh-git-c-com/a1bfa4de-60d5-4f26-80f7-ed193de463ed/scratchpad/bos3 $C -o $FT/x.i
